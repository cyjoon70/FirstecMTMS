...
namespace CS.CSB019
{
    public partial class CSB019 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void CSB019_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void Set_Span()
        {
            ...
            int cnt0 = 1;
            int cnt1 = 1;
            int i1 = SystemBase.Base.GridHeadIndex(GHIdx1, "품목명");
            ...
            for (int i = 0; i < fpSpread1.Sheets[0].RowCount; i++)
            {
                ...
                if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목명")].Text.IndexOf("소계") > -1) //소계
                {
                ...
                else if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "수주품목")].Text == "합계") //합계
                {
                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목명")].Text = "합계";
        ...
        protected override void ExcelExec()
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    oWorkSheet.get_Range("A1", "H1").Merge(true);
                    oWorkSheet.get_Range("A1", "H1").HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    oWorkSheet.get_Range("A1", "H1").Font.Size = 20;
                    ...
                    {
                        if (HeadColCnt == 1 || HeadColCnt == 3) continue;
                    ...
                    Excel.Range eRange = oWorkSheet.get_Range(oWorkSheet.Cells[6, 1], oWorkSheet.Cells[iRow - 1, 1]);
        ...
        private void CSB019_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProject_No.Focus();
        }

        private void CSB019_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
