...
namespace QR.QRA031
{
    public partial class QRA031 : UIForm.FPCOMM1
    {
        #region 생성자
        public QRA031()
        {
        ...
        #region Form Load시
        private void QRA031_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = " usp_QRA031  @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pDECISION_CD = '" + cboDecisionCd.SelectedValue + "'";
