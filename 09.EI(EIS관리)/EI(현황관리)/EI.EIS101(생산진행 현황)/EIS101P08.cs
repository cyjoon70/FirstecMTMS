...
namespace EI.EIS101
{
    public partial class EIS101P08 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjNo = "";
        string strProjSeq = "";
        ...
        public EIS101P08(string P_No, string P_Seq, string P_item, string Gi_Dt)
        {
            //
        ...
        #region Form Load 시
        private void EIS101P08_Load(object sender, System.EventArgs e)
        {
            this.Text = "구매입고준수율";
        ...
        private void Search(bool msg)
        {
            ...
            try
            {
                string strQuery = " usp_EIS101  @pTYPE = 'S08'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    BindSeries(c1Chart1, 0, dv, "입고율", "구분");
                    BindSeries(c1Chart1, 1, dv, "납기준수율");
                }
            }
            catch (Exception f)
            {
