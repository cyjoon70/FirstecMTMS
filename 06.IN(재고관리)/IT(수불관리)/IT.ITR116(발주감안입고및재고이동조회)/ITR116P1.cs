#region 작성정보
/************************************************************************/
// 단위업무명:  발주감안 입고및재고이동 조회 팝업창
// 작 성 자  :  2017.08.28.
// 작 성 일  : 
// 작성내용  :  발주감안등록 구매오더의 발주감안 및 재고이동수량 조회 팝업
// 비    고  :
/************************************************************************/
#endregion
...
namespace IT.ITR116
{
    public partial class ITR116P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strPoNo;
        string strPoSeq;
        ...
        #region 생성자
        public ITR116P1(string PoNo, string PoSeq, decimal PoQty, string ReqNo, string ReqSeq, decimal ReqQty, string ProjectNo, string ProjectSeq, string ItemCd, string ItemNm, 
		...
		#region Form Load 시
		private void ITR116P1_Load(object sender, System.EventArgs e)
        {
