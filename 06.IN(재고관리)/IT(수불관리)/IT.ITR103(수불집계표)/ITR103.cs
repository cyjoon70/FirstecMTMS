...
namespace IT.ITR103
{
    public partial class ITR103 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void ITR103_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    // 2018.07.25. hma 추가(Start): 과제사업제외 항목 체크
                    string strSubjExclude;
                    if (chkSubjExclude.Checked == true)
                        strSubjExclude = "Y";
                    else
                        strSubjExclude = "N";
                    // 2018.07.25. hma 추가(End)

                    // 2018.10.31. hma 수정:  구매입고프로젝트변경 포함 수불집계표를 별도 개발하여 이 화면은 다시 원래대로 수정하느라 주석 처리.
                    ...
                    strQuery += ", @pSUBJ_EXCLUDE = '" + strSubjExclude + "' ";             // 2018.07.25. hma 추가: 과제사업제외 항목값
        ...
        private void btnPreview_Click(object sender, System.EventArgs e)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                string RptName = SystemBase.Base.ProgramWhere + @"\Report\ITR103.rpt";    // 레포트경로+레포트명
        ...
        private void ITR103_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void ITR103_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
