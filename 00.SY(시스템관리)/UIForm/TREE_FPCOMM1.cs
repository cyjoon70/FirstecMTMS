...
namespace UIForm
{
    public partial class TREE_FPCOMM1 : Buttons
    {
        int GridSelectRow = 0;
        ...
        #region TREE_FPCOMM1_Load
        private void TREE_FPCOMM1_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        #region TREE_FPCOMM1_Closing
        private void TREE_FPCOMM1_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        private void fpSpread1_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            try
            {
                if (e.Control && e.KeyCode == Keys.C)
                {
                    ...
                    fpSpread1.Sheets[0].ClipboardCopy(ClipboardCopyOptions.Values);
                }
        ...
        private void TREE_FPCOMM1_KeyDown(object sender, KeyEventArgs e)
        {
