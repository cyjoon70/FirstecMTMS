...
namespace MI.MIM507
{
    public partial class MIM507 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void MIM507_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        //요청부서
        private void btnReqDept_Click(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void txtReqDeptCd_TextChanged(object sender, System.EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                strReorgid = dt.Rows[0][0].ToString();
            }
            else
            {
                strReorgid = "";
            ...
            txtReqDeptNm.Value = SystemBase.Base.CodeName("DEPT_CD", "DEPT_NM", "B_DEPT_INFO", txtReqDeptCd.Text, " And REORG_ID = '" + strReorgid + "' AND CO_CD = '" + SystemBase.Base.gstrCOMCD + "'");
        }
        #endregion
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery = "usp_MIM507 @pTYPE = 'S1'";
