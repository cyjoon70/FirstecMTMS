...
namespace EI.EIS101
{
    public partial class EIS101P13 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjNo = "";
        string strProjSeq = "";
        ...
        public EIS101P13(string P_No, string P_Seq, string P_item, string Gi_Dt)
        {
            //
        ...
        #region Form Load 시
        private void EIS101P13_Load(object sender, System.EventArgs e)
        {
            this.Text = "납품 준수율";
        ...
        private void Search(bool msg)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    BindSeries(c1Chart1, 0, dv, "납품율", "품목코드");
