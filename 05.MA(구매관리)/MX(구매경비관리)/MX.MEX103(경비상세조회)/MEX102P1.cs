...
namespace MX.MEX103
{  
    public partial class MEX102P1 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void MEX102P1_Load(object sender, System.EventArgs e)
        {  
            //GroupBo x1 초기화
            ...
            dtpPoDtTo.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).ToShortDateString().Substring(0,10);
        ...
        private void btnPoType_Click(object sender, System.EventArgs e)
        {
            try
            {
                string strQuery = "usp_B_COMMON @pTYPE = 'TABLE_POP', @pSPEC1='PO_TYPE_CD', @pSPEC2 = 'PO_TYPE_NM', @pSPEC3 = 'M_PO_TYPE'";
        ...
        private void butPurDuty_Click(object sender, System.EventArgs e)
        {
            try
            {
                string strQuery = " usp_M_COMMON 'M011' ,@pSPEC1='" + SystemBase.Base.gstrBIZCD + "'";
                string[] strWhere = new string[] { "@pCODE", "@pNAME" };
        ...
        private void Grid_Search(bool Msg)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_MEX102 @pTYPE = 'P1'";
