...
namespace SF.SFB002
{
    public partial class SFB002 : UIForm.FPCOMM1 
    {
        #region 변수선언
        string strSchNo = "";
        string strBtn = "N";
        ...
        #region Form Load 시
        private void SFB002_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_SFB002 @pTYPE = 'S1'";
        ...
        //창고
        private void btnSlCd_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            txtShipCustNm.Value = SystemBase.Base.CodeName("CUST_CD", "CUST_NM", "B_CUST_INFO", txtShipCust.Text, "");
        }
        ...
        //창고
        private void txtSlCd_TextChanged(object sender, EventArgs e)
        {
            txtSlNm.Value = SystemBase.Base.CodeName("SL_CD", "SL_NM", "B_STORAGE_INFO", txtSlCd.Text, "");
        }
        ...
        {
            txtMoveTypeNm.Value = SystemBase.Base.CodeName("MOVE_TYPE", "MOVE_TYPE_NM", "I_MOVE_TYPE", txtMoveType.Text, " AND TRAN_TYPE = 'DI'");
        }
        #endregion
    }
}
