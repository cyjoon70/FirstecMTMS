...
namespace PB.PSB022
{
    public partial class PSB022 : UIForm.Buttons
    {
        public PSB022()
        {
            InitializeComponent();
        ...
        #region Form Load시
        private void PSB022_Load(object sender, System.EventArgs e)
        {
            //필수 체크
        ...
        protected override void SearchExec()
        {
            try
            {
                ...
                {
                    string sql = " usp_PSB022 @pTYPE = 'S1' ";
                    sql += " , @pPLANT_CD ='" + txtPLANT_CD.Text + "' ";
                    sql += " , @pSCH_ID ='" + txtSCH_ID.Text + "' ";
                    sql += " , @pPROJ_NO ='" + txtPROJ_NO.Text + "' ";
                    ...
                    /******************************프로젝트 별 색깔 주기위해***********************************/
                    string strSql2 = "usp_PSB022 'S2'";
                    strSql2 += " , @pPLANT_CD ='" + txtPLANT_CD.Text + "' ";
                    strSql2 += " , @pSCH_ID ='" + txtSCH_ID.Text + "' ";
