...
namespace EI.EIS101
{
    public partial class EIS101P07 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjNo = "";
        string strProjSeq = "";
        ...
        public EIS101P07(string P_No, string P_Seq, string P_item, string Gi_Dt)
        {
            //
        ...
        #region Form Load 시
        private void EIS101P07_Load(object sender, System.EventArgs e)
        {
            this.Text = "자재발주";
        ...
        private void Search(bool msg)
        {
            ...
            try
            {
                string strQuery = " usp_EIS101  @pTYPE = 'S07'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    BindSeries(c1Chart1, 0, dv, "발주율", "구분");
