...
namespace MO.MIM519
{
    public partial class MIM519P4 : UIForm.FPCOMM1
    {
        #region 변수선언
        string returnVal;
        string strPoNo;
        ...
        public MIM519P4(FarPoint.Win.Spread.FpSpread spread, string PoNo)
        {
            InitializeComponent();
            spd = spread;
            strPoNo = PoNo;
        ...
        #region 폼로드 이벤트
        private void MIM519P4_Load(object sender, EventArgs e)
        {
            this.Text = "품질증빙 일괄적용";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = "usp_MIM519  @pTYPE = 'P4'";
