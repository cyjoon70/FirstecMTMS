...
namespace DA.DAA003
{
    public partial class DAA003P13 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P13()
        public DAA003P13(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P13_Load
        private void DAA003P13_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "포장형태")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D025', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 1);
        ...
        #region DAA003P13_Shown
        private void DAA003P13_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
