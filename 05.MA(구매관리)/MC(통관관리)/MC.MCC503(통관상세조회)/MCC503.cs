...
namespace MC.MCC503
{
    public partial class MCC503 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void MCC503_Load(object sender, System.EventArgs e)
        {
        ...
        private void MCC503_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtBeneficiaryCust.Focus();
        }

        private void MCC503_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
