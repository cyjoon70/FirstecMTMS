...
namespace MX.MEX103
{  
    public partial class MEX102P4 : UIForm.FPCOMM1
    {
        string returnVal = null;
        string strLckind = "";

        public MEX102P4(string Kind)
        {
            strLckind = Kind;
        ...
        #region Form Load 시
        private void MEX102P4_Load(object sender, System.EventArgs e)
        {
            this.Text = "L/C번호팝업";
            //GroupBo x1 초기화
        ...
        private void Grid_Search(bool Msg)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    ...
                    switch (strLckind)
                    {
                        case "VL": strGbn = "P4"; break;
                        case "VO": strGbn = "P5"; break;
                        default: strGbn = ""; break;
                    }

                    string strQuery = "usp_MEX102 @pTYPE = '" + strGbn + "'";
        ...
        {
            RtnStr(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "L/C번호")].Text);
