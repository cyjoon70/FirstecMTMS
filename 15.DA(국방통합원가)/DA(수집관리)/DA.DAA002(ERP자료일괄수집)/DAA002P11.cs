...
namespace DA.DAA002
{
    public partial class DAA002P11 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA002P11()
        //public DAA002P11(int DETAIL_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string NIIN, string FormId)
        public DAA002P11(string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P11_Load
        private void DAA002P11_Load(object sender, EventArgs e)
        {
           ...
           // SystemBase.Validation.GroupBox_Reset(groupBox1);
            ...
            //제출업체
            SystemBase.ComboMake.C1Combo(cboM_MNUF_CODE, "usp_CO_COMM_CODE @pTYPE = 'COMM', @pCOMP_CODE = 'SYS'  , @pCODE = 'CO010'");
            //부서
            SystemBase.ComboMake.C1Combo(cboM_DPRT_CODE, "usp_CO_COMM_CODE @pTYPE = 'COMM', @pCOMP_CODE = 'SYS'  , @pCODE = 'BA018'");
        ...
        {
            //G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "단위")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='UNIT', @pCOMP_CODE = 'SYS', @pCODE = ''", 0);
            
            strSql = " usp_DAA002P11  ";
            strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA002P11_Shown
        private void DAA002P11_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
