...
namespace QD.QDE023
{
    public partial class QDE023 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        #endregion
        ...
        public QDE023(string InspReqNo)
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void QDE023_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string TDEC_YN = "";
                    string EXM_YN = "";
                    string strQuery = " usp_QDE023  @pTYPE = 'S1'";
        ...
        private void butUpdate_Click(object sender, EventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                QDE023P1 myForm = new QDE023P1(fpSpread1, fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "QNC NO")].Text, fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "처리결과")].Text);
        ...
        private void btnDeptCd_Click_1(object sender, EventArgs e)
        {
            try
            {
