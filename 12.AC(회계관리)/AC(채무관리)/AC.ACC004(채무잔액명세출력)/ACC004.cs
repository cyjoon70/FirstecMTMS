...
namespace AC.ACC004
{
    public partial class ACC004 : UIForm.Buttons
    {
        public ACC004()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACC004_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = SystemBase.Base.ProgramWhere + @"\Report\ACC004.rpt";    // 레포트경로+레포트명
                    string[] RptParmValue = new string[7];   // SP 파라메타 값

                    RptParmValue[0] = "P1";
                    RptParmValue[1] = SystemBase.Base.gstrCOMCD;
                    RptParmValue[2] = dtpStdDt.Text;
                    RptParmValue[3] = txtCustCdFrom.Text;
                    RptParmValue[4] = txtCustCdTo.Text;
