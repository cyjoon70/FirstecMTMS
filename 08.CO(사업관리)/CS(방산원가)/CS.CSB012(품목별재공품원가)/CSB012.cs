...
namespace CS.CSB012
{
    public partial class CSB012 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void CSB012_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void CSB012_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProject_No.Focus();
        }

        private void CSB012_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
