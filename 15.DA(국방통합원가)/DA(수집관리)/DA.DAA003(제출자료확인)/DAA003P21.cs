#region DAA003P21 작성 정보
/*************************************************************/
// 단위업무명 : 지급임차료전용 엑셀 파일 업로드 처리
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-07
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P21 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P21()
        public DAA003P21(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P21_Load
        private void DAA003P21_Load(object sender, EventArgs e)
        {
        ...
        private void DAA003P21_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
