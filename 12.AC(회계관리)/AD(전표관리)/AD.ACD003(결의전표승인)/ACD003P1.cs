...
namespace AD.ACD003
{
    public partial class ACD003P1 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void ACD003P1_Load(object sender, System.EventArgs e)
        {
        ...
        #region 엔터키 조회
        private void ACD003P1_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
