#region DAA003P15 작성 정보
/*************************************************************/
// 단위업무명 : 설물발생액 엑셀 파일 업로드 처리.
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-06
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P15 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P15()
        public DAA003P15(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P15_Load
        private void DAA003P15_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P15_Shown
        private void DAA003P15_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
