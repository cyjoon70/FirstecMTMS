...
namespace EP.EPR002
{
    public partial class EPR002 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjectNo = "";
        ...
        #region Form Load시
        private void EPR002_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_EPR002 @pType='S1'  ";
        ...
        private void Search_1(int idx, string Series1, string Series2)
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G" + Convert.ToString(idx + 1) + "'  ";
        ...
        private void Search_5()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G5'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + strProjectNo + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void Search_6()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G6'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + strProjectNo + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void Search_7()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G7'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + strProjectNo + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void Search_8()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G8'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + strProjectNo + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void Search_9()
        {
            try
            {
                ...
                string strQuery1 = " usp_EPR002 @pType='G9'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + strProjectNo + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        #region Activated
        private void EPR002_Activated(object sender, System.EventArgs e)
        {
            txtProjectNo.Focus();
        }
        #endregion
