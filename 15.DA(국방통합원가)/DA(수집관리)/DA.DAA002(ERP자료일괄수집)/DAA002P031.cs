...
namespace DA.DAA002
{
    public partial class DAA002P031 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P031
        public DAA002P031(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P031_Load
        private void DAA002P031_Load(object sender, EventArgs e)
        {
        ...
        #region DAA002P031_Shown()
        private void DAA002P031_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
