...
namespace CZ.CZA010
{
    public partial class CZA010 : UIForm.Buttons
    {
        public CZA010()
        {
            InitializeComponent();
        ...
        #region Form Load시
        private void CZA010_Load(object sender, System.EventArgs e)
        {
            //필수 체크
        ...
        private void btnExec_Click(object sender, EventArgs e)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                CZA010P1 frm = new CZA010P1(strWorkType
        ...
        private void CloseMont()
        {
            ...
            try
            {
                ...
                string Query = " usp_CZA010 @pTYPE = '" + strGbn + "'";
