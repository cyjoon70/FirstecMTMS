...
namespace QF.QFA031
{
    public partial class QFA031 : UIForm.FPCOMM1
    {
        #region 생성자
        public QFA031()
        {
        ...
        #region Form Load시
        private void QFA031_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            SystemBase.ComboMake.C1Combo(cboInspStatus, "usp_B_COMMON @pType='COMM', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "',@pCODE = 'Q003', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0); //검사진행상태
            ...
            SystemBase.ComboMake.C1Combo(cboFinInspLvl, "usp_B_COMMON @pType='COMM', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "',@pCODE = 'Q013', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 9); //최종검사레벨
            ...
            dtpInspDtFr.Value = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-3).ToString().Substring(0, 10);
            dtpInspDtTo.Value = SystemBase.Base.ServerTime("YYMMDD").ToString().Substring(0, 10);
            cboInspStatus.SelectedValue = "R";
        }
        #endregion
        ...
        //작업장
        private void txtWc_Cd_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtProjectNo_TextChanged(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    txtProjectNm.Value = SystemBase.Base.CodeName("PROJECT_NO", "PROJECT_NM", "S_SO_MASTER", txtProjectNo.Text, " AND COMP_CODE ='" + SystemBase.Base.gstrCOMCD + "'");
                }
                else
                {
                    txtProjectNm.Value = "";
        ...
        private void txtInspectorCd_TextChanged(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    txtInspectorNm.Value = SystemBase.Base.CodeName("MINOR_CD", "CD_NM", "B_COMM_CODE", txtInspectorCd.Text, " AND MAJOR_CD = 'Q005' AND LANG_CD = '" + SystemBase.Base.gstrLangCd + "' AND CO_CD ='" + SystemBase.Base.gstrCOMCD + "'");
                }
                else
                {
        ...
        protected override void SearchExec()
        {
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = " usp_QFA031  @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pFIN_INSP_LVL = '" + cboFinInspLvl.SelectedValue.ToString() + "' ";
