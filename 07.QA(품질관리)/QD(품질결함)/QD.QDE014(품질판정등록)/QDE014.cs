...
namespace QD.QDE014
{
    public partial class QDE014 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        #endregion
        ...
        public QDE014(string InspReqNo)
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void QDE014_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQdecEntYn = "";
                    if (rdoQdecEntYnNo.Checked == true)
                    { strQdecEntYn = "N"; }

                    string strQuery = " usp_QDE014  @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pQDEC_ENT_YN = '" + strQdecEntYn + "'";
        ...
        private void butUpdate_Click(object sender, EventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                QDE014P1 myForm = new QDE014P1(fpSpread1, iRow
