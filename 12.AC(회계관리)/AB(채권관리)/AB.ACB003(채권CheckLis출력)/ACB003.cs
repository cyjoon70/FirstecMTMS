...
namespace AB.ACB003
{
    public partial class ACB003 : UIForm.Buttons
    {
        public ACB003()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACB003_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void NewExec()
        {
            ...
            dtpArDtFr.Text = YYMMDD.Substring(0, 7) + "-01";
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = SystemBase.Base.ProgramWhere + @"\Report\ACB003.rpt";    // 레포트경로+레포트명
                    string[] RptParmValue = new string[8];   // SP 파라메타 값

                    RptParmValue[0] = "P1";
                    RptParmValue[1] = SystemBase.Base.gstrCOMCD;
                    RptParmValue[2] = dtpArDtFr.Text;
                    RptParmValue[3] = dtpArDtTo.Text;
                    RptParmValue[4] = txtCustCdFrom.Text;
                    RptParmValue[5] = txtCustCdTo.Text;
