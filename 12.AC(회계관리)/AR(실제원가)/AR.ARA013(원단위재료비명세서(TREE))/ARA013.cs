...
namespace AR.ARA013
{
    public partial class ARA013 : UIForm.FPCOMM1
    {
        #region 변수선언       
        ...
        #region Form Load 시
        private void ARA013_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            try
            {
                ...
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    if (fpSpread1.Sheets[0].RowCount > 0)
                    {
                        ...
                        {
                            if (fpSpread1.Sheets[0].Cells[i, 1].Text == "합계") 
                            {
