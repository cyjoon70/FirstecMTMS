...
namespace MP.MPO101
{
    public partial class MPO101 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void MPO101_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            SystemBase.ComboMake.C1Combo(cboPoType, "usp_B_COMMON @pTYPE = 'TABLE', @pCODE = 'PO_TYPE_CD', @pNAME = 'PO_TYPE_NM', @pSPEC1 = 'M_PO_TYPE', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'");
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "VAT포함구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'S019', @pLANG_CD = '" + SystemBase.Base.gstrLangCd.ToString() + "' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0);//품목계정
            ...
            cboPoType.SelectedValue = "DO"; //내자발주 default
        ...
        {
            UIForm.TabFPMake.TabPageColor(c1DockingTabPage1); //품목정보
            UIForm.TabFPMake.TabPageColor(c1DockingTabPage2); //계획정보           
        ...
        protected override void RowInsExec()
        {
            ...
            if (rdoCfmY.Checked == false)
            {
                if (Convert.ToString(cboPoType.SelectedValue) != "")
                {
                    ...
                    fpSpread1.Sheets[0].Cells[fpSpread1.Sheets[0].ActiveRowIndex, SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가")].Value = 0;
                    fpSpread1.Sheets[0].Cells[fpSpread1.Sheets[0].ActiveRowIndex, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체")].Text = "";             // 2022.05.19. hma 추가
                    fpSpread1.Sheets[0].Cells[fpSpread1.Sheets[0].ActiveRowIndex, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체명")].Text = "";           // 2022.05.19. hma 추가
        ...
        private void Search(string strPoNo)
        {
            ...
            try
            {
                ...
                string strQuery = " usp_MPO101  @pTYPE = 'S1'";
                    ...
                    if (fpSpread1.Sheets[0].Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            if (NewFlg != 0)
                            {
                                ...
                                string strSql = " usp_MPO101 '" + strMstType + "'";
                                ...
                                strSql += ", @pCUST_REMARK = '" + txtCUSTREMARK.Text.Replace("'", "''") + "' ";
                                ...
                                if (cboConType.Text != "")
                                {
                                    strSql += ", @pCON_TYPE = '" + cboConType.SelectedValue.ToString() + "'";
                                }
                                strSql += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                            ...
                            if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                            {
                                ...
                                if (DelCheck() == false)
                                {
                                    ...
                                    if (dsMsg == DialogResult.Yes)
                                    {
                                        try
                                        {
                                            string strDelSql = " usp_MPO101  'D1'";
                                ...
                                for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                                {
                                    ...
                                    if (strHead.Length > 0)
                                    {
                                        ...
                                        string strSql = " usp_MPO101 '" + strGbn + "'";
                                        strSql += ", @pPO_NO = '" + strAutoPoNo + "' ";
                                        ...
                                        strSql += ", @pCOST_AMT_LOC  = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "원가단가")].Value + "' ";       // 2019.02.22. hma 수정: 원가금액=>원가단가
                                        ...
                                        strSql += ", @pREMARK1 = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "비고")].Text.Replace("'", "''") + "' ";

                                        if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가")].Text.Trim() != "")
                                            strSql += ", @pPRE_PO_PRICE = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가")].Value + "' ";
                                        // 2022.05.19. hma 추가(Start): 종전발주업체
                                        if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체")].Text.Trim() != "")
                                            strSql += ", @pPRE_CUST_CD = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체")].Value + "' ";
                                        // 2022.05.19. hma 추가(End)
                                        strSql += ", @pUP_ID = '" + SystemBase.Base.gstrUserID + "'";
                                        strSql += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
        ...
        protected override void fpButtonClick(int Row, int Column)
        {
            ...
            {
                MPO101P3 frm3 = new MPO101P3(strAutoPoNo, fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "발주순번")].Text);
                ...
                if (frm3.DialogResult == DialogResult.OK)
                {
                    ...
                    //    UIForm.FPMake.fpChange(fpSpread1, Row);//수정플래그
                    //}
                    if (Val != fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "품질증빙")].Text && Msgs == "Y")
                    {
                        fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "품질증빙")].Text = Val;
                        UIForm.FPMake.fpChange(fpSpread1, Row);//수정플래그
                    }
                }
            }
        ...
        {
            string Query = "usp_MPO101 @pTYPE = 'S4'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가")].Value = dt.Rows[0][0];
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "적용일자")].Value = dt.Rows[0][1];
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체")].Value = dt.Rows[0][2];      // 2022.05.19. hma 추가
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체명")].Value = dt.Rows[0][3];    // 2022.05.19. hma 추가
            }
            else
            {
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가")].Value = 0;
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "적용일자")].Text = "";
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체")].Text = "";                  // 2022.05.19. hma 추가
                fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체명")].Text = "";                // 2022.05.19. hma 추가
            }	
        }
        ...
        private void SubSearch(string strCode)
        {
            ...
            try
            {
                ...
                txtCUSTREMARK.Value = dt.Rows[0]["CUST_REMARK"].ToString();
            ...
            try
            {
                ...
                if (strCfm == "Y")
                {
                    ...
                    UIForm.FPMake.grdReMake(fpSpread1,
                        ...
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "프로젝트차수") + "|3"
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "프로젝트차수_2") + "|3"
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "품질증빙_2") + "|3"
                        ...
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가") + "|3"
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체") + "|3"            // 2022.05.19. hma 추가
                        + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체명") + "|3"          // 2022.05.19. hma 추가
                        );
                    ...
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "전용여부")].Text == "N") //프로젝트, 차수 realonly
                            UIForm.FPMake.grdReMake(fpSpread1, i,
                                ...
                                + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "프로젝트차수") + "|3"
                                + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "프로젝트차수_2") + "|3"
                                + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "품질증빙_2") + "|0"
                                ...
                                + "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전단가") + "|0"
                                //+ "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체") + "|1"        // 2022.05.19. hma 추가
                                //+ "#" + SystemBase.Base.GridHeadIndex(GHIdx1, "종전업체명") + "|1"      // 2022.05.19. hma 추가
                                );
                        else
                            UIForm.FPMake.grdReMake(fpSpread1, i,
                                        SystemBase.Base.GridHeadIndex(GHIdx1, "일괄선택") + "|0"
        ...
        private void Set_Tab2(string div, string mode)
        {
            if (div == "0")
            {
                SystemBase.Base.GroupBoxLock(groupBox4, false);
                if (mode == "U") SystemBase.Base.GroupBoxReset(groupBox4);
                dtpContDt.Tag = "";
                txtCostCond.Tag = "";
                txtTransMeth.Tag = "";
                txtACsut.Tag = "";
        ...
        private void butCust_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (pu.DialogResult == DialogResult.OK)
                {
                    ...
                    txtCustDutyNm.Text = Msgs[15].ToString();
                    if (Msgs[18].ToString() == "")
                        txtCustTel.Text = Msgs[13].ToString();
                    else
                        txtCustTel.Text = Msgs[18].ToString();
                }
        ...
        private void butPayout_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (pu.DialogResult == DialogResult.OK)
                {
                    ...
                    txtPayoutMeth.Text = Msgs[0].ToString();
        ...
        private void btnReqRef_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (Convert.ToString(cboPoType.SelectedValue) != "")
                {
                    MPO101P1 frm1 = new MPO101P1(fpSpread1, cboPoType.SelectedValue.ToString());
        ...
        private void btnEstRef_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (Convert.ToString(cboPoType.SelectedValue) != "")
                {
                    MPO101P2 frm2 = new MPO101P2(fpSpread1, cboPoType.SelectedValue.ToString());
        ...
        private void btnQualityAll_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (get_Check())
                {
                    ...
                    MPO101P4 frm1 = new MPO101P4(fpSpread1, strAutoPoNo);
                    frm1.WindowState = FormWindowState.Normal;
                    frm1.ShowDialog();
                    if (frm1.DialogResult == DialogResult.OK)
                    {
        ...
        private void cboPoType_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (im_yn == "Y")
                {
                    ...
                    dtpContDt.Value = SystemBase.Base.ServerTime("YYMMDD");
