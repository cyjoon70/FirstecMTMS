...
namespace DA.DAA001
{
    public partial class DAA001P1 : UIForm.FPCOMM1
    {
        #region 리턴될 변수선언
        ...
        #region DAA001P1(KEY_GROUP)
        public DAA001P1()
        {
            InitializeComponent();
        }
        public DAA001P1(string ORDER_YEAR, string DCSN_NUMB)
        {
            strDCSN_NUMB = DCSN_NUMB;
            strORDER_YEAR = ORDER_YEAR;
            InitializeComponent();
        }
        #endregion

        #region DAA001P1_Load
        private void DAA001P1_Load(object sender, EventArgs e)
        {
            ...
            txtDCSN_NUMB.Value = strDCSN_NUMB;
            txtORDER_YEAR.Value = strORDER_YEAR;
        ...
        protected override void SearchExec()
        {
            try
            {
                ...
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))  //필수조회조건 체크
                {
                    ...
                    strSql += ", @pORDR_YEAR = '" + txtORDER_YEAR.Text + "' ";
                    strSql += ", @pITEM_CD = '" + txtITEM_CD.Text + "' ";
                    strSql += ", @pITEM_NM = '" + txtITEM_NM.Text + "' ";
                    strSql += ", @pNIIN = '" + txtNATION_STOCK_NO.Text + "' ";
