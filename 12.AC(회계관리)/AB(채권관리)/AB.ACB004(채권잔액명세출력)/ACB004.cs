...
namespace AB.ACB004
{
    public partial class ACB004 : UIForm.Buttons
    {
        public ACB004()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACB004_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = SystemBase.Base.ProgramWhere + @"\Report\ACB004.rpt";    // 레포트경로+레포트명
