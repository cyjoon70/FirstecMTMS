#region DAA003P11 작성 정보
/*************************************************************/
// 단위업무명 : 수입재료비 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-06
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P11 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P11()
        public DAA003P11(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P11_Load
        private void DAA003P11_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P11_Shown
        private void DAA003P11_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
