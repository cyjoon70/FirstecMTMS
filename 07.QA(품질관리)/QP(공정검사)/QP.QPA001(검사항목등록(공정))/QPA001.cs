...
namespace QP.QPA001
{
    public partial class QPA001 : UIForm.FPCOMM2
    {
        #region 변수선언
        string strInspReqNo = "";
        int SearchRow = 0;
        int ShowColumn = 0;
        string strDecisionCd = "";
        string strPlantCd = "";
        string strInspReqDt = "";
        ...
        public QPA001(string param1, string param2, string param3, string param4)
        {
            strInspReqNo = param1;
            strPlantCd = param2;
            strInspReqDt = param3;
        ...
        #region Form Load 시
        private void QPA001_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            strJumpFileName5 = "QP.QPA002.QPA002"; //호출할 화면명
        }
        #endregion
        ...
        private void Grid2_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QPA001  @pTYPE = 'S1'";
        ...
        private void Grid1_Search(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QPA001  @pTYPE = 'S2'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    string strSql = " usp_QPA001 '" + strGbn + "'";
        ...
        private void btnInspBase_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_QPA001  @pTYPE = 'R1'";
                strQuery1 += ", @pPLANT_CD = '" + cboSPlantCd.SelectedValue.ToString() + "' ";
                strQuery1 += ", @pITEM_CD = '" + txtItemCd.Text + "' ";
                strQuery1 += ", @pROUT_NO = '" + txtRoutNo.Text + "' ";
                strQuery1 += ", @pPROC_SEQ = '" + txtProcSeq.Text + "' ";
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    string strQuery2 = " usp_QPA001  @pTYPE = 'R2'";
