...
namespace AG.ACG201
{
    public partial class ACG201 : UIForm.FPCOMM1 
    {
        public ACG201()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACG201_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void NewExec()
        {
            ...
            dtpOpenpDtFr.Value = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-3).ToShortDateString();
            dtpOpenpDtTo.Value = SystemBase.Base.ServerTime("YYMMDD");
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_ACG201  'S1'";
                    strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                    strQuery += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                    strQuery += ", @pOPEN_DT_FROM = '" + dtpOpenpDtFr.Text + "' ";
                    strQuery += ", @pOPEN_DT_TO = '" + dtpOpenpDtTo.Text + "' ";
