...
namespace PA.PBA172
{
    public partial class PBA172P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void PBA172P1_Load(object sender, EventArgs e)
        {
            this.Text = "라우팅조회";
            ...
            if (SystemBase.Base.ProgramWhere.Length > 0)
            {
                ...
                HeadQuery += " FROM   B_GRID_DESIGN ";
                HeadQuery += " WHERE  LANG_CD='" + SystemBase.Base.gstrLangCd + "'";
                HeadQuery += " AND    FORM_ID='" + routFrmId + "'";
            ...
            // 공정확인조회
            string Query = " usp_PBA172 @pType='S6', @pCO_CD = '"+ SystemBase.Base.gstrCOMCD.ToString() +"' ";
