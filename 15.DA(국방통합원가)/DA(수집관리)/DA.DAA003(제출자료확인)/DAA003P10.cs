...
namespace DA.DAA003
{
    public partial class DAA003P10 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P10()
        public DAA003P10(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P10_Load
        private void DAA003P10_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P10_Shown
        private void DAA003P10_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
