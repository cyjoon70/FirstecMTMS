...
namespace QD.QDE013
{
    public partial class QDE013P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        string strCfm = "";
        ...
        public QDE013P2(string InspReqNo)
        {
            InitializeComponent();
        ...
        public QDE013P2(string InspReqNo, string cfm_yn)
        {
            InitializeComponent();
        ...
        #region 폼로드 이벤트
        private void QDE013P2_Load(object sender, System.EventArgs e)
        {
            this.Text = "알리미등록";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = " usp_QDE013  @pTYPE = 'P2'";
                ...
                try
                {
                    ...
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead.Length > 0)
                        {
                            ...
                            string strSql = " usp_QDE013 '" + strGbn + "'";
