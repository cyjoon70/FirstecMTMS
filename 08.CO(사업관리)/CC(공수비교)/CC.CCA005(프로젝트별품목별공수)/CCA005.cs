...
namespace CC.CCA005
{
    public partial class CCA005 : UIForm.FPCOMM1
    {
        #region 생성자
        public CCA005()
        {
        ...
        #region Form Load 시
        private void CCA005_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            rdoWorkTypeMfg.Checked = true;      // 2019.03.25. ksh 추가
        }
        #endregion
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    // 2019.03.25. ksh 추가(Start): 작업구분 검색조건 체크
                    string strWorkType = "";
                    ...
                    if (rdoWorkTypeMfg.Checked == true)
                        ...
                        strWorkType = "D";
                    // 2019.03.25. ksh 추가(End)

                    string strQuery = "usp_CCA005 @pTYPE = 'S1'";
                    ...
                    strQuery = strQuery + ", @pWORK_TYPE = '" + strWorkType + "' ";     // 2019.03.25. ksh 추가 : 작업구분 검색조건
