...
try
{
    WNDW.ACD007P2 pu = new WNDW.ACD007P2(txtSLIP_NO.Text);
    pu.ShowDialog();
}
catch (Exception f)
{
...
namespace AD.ACD007
{
    ...
    /// </summary>
    public partial class ACD007P2 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public ACD007P2(string SLIP_NO, string ADMIN_YN, string FINANCE_YN)
        {
            strSLIPNO = SLIP_NO;
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_ACD007P2  'S2'";
        ...
        private void SEARCH_SLIP(string SLIP_NO)
        {
            ...
            {
                //상세조회 SQL
                string strQuery = " usp_ACD007P2  'S1'";
                strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
        ...
        private void CTRL_SEARCH(string SLIP_SEQ)
        {
            ...
            {
                //상세조회 SQL
                string strQuery = " usp_ACD007P2  'S3'";
                strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
