...
namespace HC.HCA011
{
    public partial class HCA011 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strEmpNo = "";
        #endregion
        ...
        #region Form Load시
        private void HCA011_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            //콤보박스 세팅
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "보험구분")] = SystemBase.ComboMake.ComboOnGrid("usp_H_COMMON @pTYPE = 'H007', @pCOM_CD = 'H0153' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0);//보험구분
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_HCA011  @pTYPE = 'S1', @pYY = '" + dtpYear.Text + "', @pEMP_NO = '" + txtEmpNo.Text + "' ";
                    ...
                    if (fpSpread1.Sheets[0].Rows.Count > 0)
                    {
                        ...
                        {
                            UIForm.FPMake.grdReMake(fpSpread1, i, SystemBase.Base.GridHeadIndex(GHIdx1, "보험구분") + "|3"
                ...
                try
                {
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead.Length > 0)
                        {
                            ...
                            string strSql = " usp_HCA011 @pTYPE = '" + strGbn + "' ";
                            ...
                            strSql = strSql + ", @pINSUR_TYPE = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "보험구분")].Value + "'";
                            strSql = strSql + ", @pINSUR_AMT = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "금액")].Value + "'";
        ...
        protected override void fpButtonClick(int Row, int Column)
        {
            ...
            {
                string strQuery = " usp_H_COMMON 'H005', @pSPEC1 = '" + txtEmpNo.Text + "', @pSPEC2 = '" + dtpYear.Text + "', @pSPEC3 = 'INSUR' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        protected override void fpSpread1_ChangeEvent(int Row, int Column)
        {
            ...
            {
                string strQuery = " usp_H_COMMON 'H006', @pSPEC1 = '" + txtEmpNo.Text + "', @pSPEC2 = '" + dtpYear.Text + "', @pSPEC3 = 'INSUR' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show(SystemBase.Base.MessageRtn("보험 여부가 'N'이거나 존재하지 않는 가족성명입니다."), SystemBase.Base.MessageRtn("Z0003"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
            }
        }
