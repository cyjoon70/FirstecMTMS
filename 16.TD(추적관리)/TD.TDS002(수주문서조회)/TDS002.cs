...
namespace TD.TDS002
{
	public partial class TDS002 : UIForm.FPCOMM2
	{
		#region 필드
		...
		#region 폼 이벤트 핸들러
		private void TDS002_Load(object sender, System.EventArgs e)
		{
			// 필수체크
			...
			cboDocCd.SetItems("usp_T_DOC_CODE @pTYPE = 'S1', @pDOC_CTG_CD = '" + docCtgCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", new string[] { "DOC_CD", "DOC_NM" }, 0, 1, new string[] { "" });
			cboDocCd.RemoveValue("EST");
