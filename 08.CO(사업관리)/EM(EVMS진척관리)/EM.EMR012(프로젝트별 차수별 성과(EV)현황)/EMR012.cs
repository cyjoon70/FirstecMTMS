#region 작성정보
/*********************************************************************/
// 단위업무명 : 프로젝트별 차수별 성과(EV)현황
// 작 성 자 : 김 현 근
// 작 성 일 : 2013-04-23
// 작성내용 : 프로젝트별 차수별 성과(EV)현황
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace EM.EMR012
{
    public partial class EMR012 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void EMR012_Load(object sender, System.EventArgs e)
        {
        ...
        private void EMR012_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProjectNo.Focus();
        }

        private void EMR012_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
