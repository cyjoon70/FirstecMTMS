...
namespace QE.QRE013
{
    public partial class QRE013P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region 생성자
        public QRE013P1(string ProjectNo, string ProjectSeq, string ItemCd, string WoNo)
        {
        ...
        #region 폼로드 이벤트
        private void QRE013P1_Load(object sender, System.EventArgs e)
        {
            this.Text = "공정진행현황";
            ...
            string Query = " usp_QRE013 @pTYPE = 'S3'";
