namespace EM.EMR009
{
    partial class EMR009
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EMR009));
            ...
            this.Name = "EMR009";
            this.Text = "프로젝트별 차수별 재료비현황";
            this.Activated += new System.EventHandler(this.EMR009_Activated);
            this.Deactivate += new System.EventHandler(this.EMR009_Deactivate);
            this.Load += new System.EventHandler(this.EMR009_Load);
