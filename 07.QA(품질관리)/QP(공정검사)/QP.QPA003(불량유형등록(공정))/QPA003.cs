...
namespace QP.QPA003
{
    public partial class QPA003 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public QPA003(string param1, string param2, string param3, string param4)
        {
            //
        ...
        #region Form Load시
        private void QPA003_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            lnkJump1.Text = "불량원인등록";  //화면에 보여지는 링크명
            strJumpFileName1 = "QP.QPA004.QPA004"; //호출할 화면명
        ...
        protected override void Link1Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA004";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "불량원인등록(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        private void Grid3_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QPA003  @pTYPE = 'S1'";
        ...
        private void Grid2_Search(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QPA003  @pTYPE = 'S2'";
        ...
        private void Grid1_Search1()
        {
            ...
            try
            {
                string strQuery = " usp_QPA003  @pTYPE = 'S3'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    if (strGbn != "")
                                    {
                                        string strSql = " usp_QPA003 '" + strGbn + "'";
        ...
        private void fpSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                if (strDecisionCd == "N")
                {
                    ...
                    {
                        UIForm.Buttons.ReButton("101111001011", BtnNew, BtnPrint, BtnSearch, BtnRCopy, BtnRowIns, BtnCancel, BtnDel, BtnDelete, BtnInsert, BtnHelp, BtnExcel, BtnClose);
                    }
                    else
                    {
