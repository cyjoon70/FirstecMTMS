...
namespace SS.SSC005
{
    public partial class SSC005 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void SSC005_Load(object sender, System.EventArgs e)
        {
            //GroupBox1 초기화
        ...
        private void SSC005_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) dtpBnDtFr.Focus();
        }

        private void SSC005_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
