...
namespace UIForm
{
    public partial class FPCOMM3 : Buttons
    {
        ...
        public string[] G3Head1 = null;// 첫번째 Head Text
        public string[] G3Head2 = null;// 두번째 Head Text
        public string[] G3Head3 = null;// 세번째 Head Text
        public int[] G3Width = null;// Cell 넓이
        public string[] G3Align = null;// Cell 데이타 정렬방식
        public string[] G3Type = null;// CellType 지정
        public int[] G3Color = null;// Cell 색상 및 ReadOnly 설정(0:일반, 1:필수, 2:ReadOnly)
        public string[] G3Etc = null;// Mask 양식 등
        public int G3HeadCnt = 0;   // Head 수
        public int[] G3SEQ = null;// 키
        ...
        {	// 행 삭제
            try
            {
                ...
                //				{
                //					GridSelectRow = fpSpread1.ActiveSheet.GetSelection(0).Row;
        ...
        protected override void ExcelExec()
        {
            try
            {
                ...
                else if (fpSpread2.Focused == true)
                    UIForm.FPMake.ExcelMake(fpSpread2, this.Text.ToString() + "_2");
                else
                    UIForm.FPMake.ExcelMake(fpSpread2, this.Text.ToString() + "_3");
        ...
        ////					ClipboardRowCount = fpSpread1.ActiveSheet.Rows.Count;
        ////
        ...
        //		}
        //
        //		private void fpSpread2_ClipboardChanging(object sender, System.EventArgs e)
        //		{
        //			try
        //			{
        ////				ClipboardRowCount = fpSpread2.ActiveSheet.GetSelection(0).RowCount;
        ////				if(ClipboardRowCount < 0)
        ////					ClipboardRowCount = fpSpread2.ActiveSheet.Rows.Count;
        ////
        ////				ClipboardColCount = fpSpread2.ActiveSheet.GetSelection(0).ColumnCount;
        ////				if(ClipboardColCount < 0)
        ////					ClipboardColCount = fpSpread2.ActiveSheet.ColumnCount;
        //			}
        //			catch(Exception f)
        //			{
        //				SystemBase.Loggers.Log(this.Name, f.ToString());
        ...
        //		}
        //
        //		private void fpSpread3_ClipboardChanging(object sender, System.EventArgs e)
        //		{
        ////			try
        ////			{
        ////				ClipboardRowCount = fpSpread3.ActiveSheet.GetSelection(0).RowCount;
        ////				if(ClipboardRowCount < 0)
        ////					ClipboardRowCount = fpSpread3.ActiveSheet.Rows.Count;
        ////
        ////				ClipboardColCount = fpSpread3.ActiveSheet.GetSelection(0).ColumnCount;
        ////				if(ClipboardColCount < 0)
        ////					ClipboardColCount = fpSpread3.ActiveSheet.ColumnCount;
        ////			}
        ////			catch(Exception f)
        ////			{
        ////				SystemBase.Loggers.Log(this.Name, f.ToString());
        ...
        //
        //				for(int i = fpSpread1.ActiveSheet.GetSelection(0).Row; i < ClipRowCount; i++)
        //				{
        ...
        #region FPCOMM1_Load
        private void FPCOMM3_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void fpSpread3_ColumnWidthChanged(object sender, FarPoint.Win.Spread.ColumnWidthChangedEventArgs e)
        {
            ...
            try
            {
                for (int i = 1; i < fpSpread3.Sheets[0].Columns.Count; i++)
                {
                    string Query = " usp_BAA004 'S4' ";
                   Query = Query + ", @pFORM_ID='" + this.Name.ToString() + "'";
                    Query = Query + ", @pGRID_NAME='fpSpread3'";
                    Query = Query + ", @pIN_ID='" + SystemBase.Base.gstrUserID + "' ";
                    Query = Query + ", @PSEQ='" + G3SEQ[i].ToString() + "' ";
                    Query = Query + ", @PHEAD_WIDTH='" + fpSpread3.Sheets[0].ColumnHeader.Cells[0, i].Column.Width.ToString() + "' ";
                    Query = Query + ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD.ToString() + "' ";

                    cmd.CommandText = Query;
                    cmd.ExecuteNonQuery();

                    G3Width[i] = Convert.ToInt32(fpSpread3.Sheets[0].ColumnHeader.Cells[0, i].Column.Width.ToString());
        ...
        private void FPCOMM3_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (strFormClosingMsg == true)
            {
                ...
                {
                    if (fpSpread3.Sheets[0].RowHeader.Cells[i, 0].Text == "I" || fpSpread3.Sheets[0].RowHeader.Cells[i, 0].Text == "U")
                        UpCount++;
                }
                if (UpCount > 0)
                {
        ...
        private void menuItem9_Click(object sender, System.EventArgs e)
        {
            ...
            if (txtRowCnt.Text != "")
            {
                ...
                {
                    Row = fpSpread3.Sheets[0].ActiveRowIndex;
                }

                fpSpread3.ActiveSheet.DrawingContainer.Redraw = false;
                ...
                fpSpread3.ActiveSheet.DrawingContainer.Redraw = true;

                if (Convert.ToInt32(txtRowCnt.Text) > 0)
                {
                    if (Row > 0)
                    {
                        fpSpread3.ActiveSheet.SetActiveCell(Row + 1, 1);
                    }
                    else
                    {
                        fpSpread3.ActiveSheet.SetActiveCell(Row, 1);
                    }

                    fpSpread3.ShowActiveCell(FarPoint.Win.Spread.VerticalPosition.Center, FarPoint.Win.Spread.HorizontalPosition.Center);
                }
            }
        ...
        private void fpSpread3_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.Control && e.KeyCode == Keys.C)
            {
                e.Handled = true;
                ...
                //fpSpread1.ClipboardOptions = FarPoint.Win.Spread.ClipboardOptions.AllHeaders;
                //fpSpread1.Sheets[0].ClipboardCopy(FarPoint.Win.Spread.ClipboardCopyOptions.AsStringSkipHidden);
                fpSpread3.Sheets[0].ClipboardCopy(ClipboardCopyOptions.All);
            }
        }
        #endregion
        ...
        #region menuItem16_Click(Grid Print)
        ...
        #region menuItem17_Click(Grid Print)
        ...
        #region menuItem18_Click(Grid Print)
        ...
        private void FPCOMM3_KeyDown(object sender, KeyEventArgs e)
        {
            FarPoint.Win.Spread.FpSpread grid;

            if (fpSpread3.Focused == true)
            {
                grid = fpSpread3;
            }
            else if (fpSpread2.Focused == true)
