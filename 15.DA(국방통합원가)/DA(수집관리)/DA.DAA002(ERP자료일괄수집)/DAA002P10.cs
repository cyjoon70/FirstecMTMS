...
namespace DA.DAA002
{
    public partial class DAA002P10 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P10 값 받아올 때
        public DAA002P10(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P10_Load
        private void DAA002P10_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 추가경비";
        }
        #endregion
        ...
        #region DAA002P10_Shown 조회
        private void DAA002P10_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
