...
namespace PF.PFA008
{
    public partial class PFA008 : UIForm.FPCOMM1
    {
        #region 변수선언
        int lastCol = 30;
        #endregion
        ...
        #region Form Load시
        private void PFA008_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_PFA008  @pTYPE = 'S1'";
                    strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'";
                    strQuery += ", @pWORK_DT_FR = '" + dtpWorkDtFr.Text + "'";
                    strQuery += ", @pWORK_DT_TO = '" + dtpWorkDtTo.Text + "'";
                    strQuery += ", @pWC_CD = '" + txtWcCd.Text + "'";
                    strQuery += ", @pPROJECT_NO = '" + txtProjectNo.Text + "' ";            // 2016.01.07 추가
                    strQuery += ", @pPROJECT_SEQ_FR = '" + txtProjectSeqFr.Text + "' ";     // 2016.01.07 추가
                    strQuery += ", @pPROJECT_SEQ_TO = '" + txtProjectSeqTo.Text + "'";      // 2016.01.07 추가
                    strQuery += ", @pITEM_CD = '" + txtItemCd.Text + "' ";                  // 2016.01.07 추가
