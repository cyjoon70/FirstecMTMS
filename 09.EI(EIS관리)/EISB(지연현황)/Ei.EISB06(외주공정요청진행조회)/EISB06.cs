...
namespace EI.EISB06
{
    public partial class EISB06 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void EISB06_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_EISB06 @pTYPE = 'S1'";
                    ...
                    {
                        int col_idx = SystemBase.Base.GridHeadIndex(GHIdx1, "요청량");
                        int col_idx1 = SystemBase.Base.GridHeadIndex(GHIdx1, "지체일수");
                        int col_idx2 = SystemBase.Base.GridHeadIndex(GHIdx1, "구매입고요구일");
                        int col_idx3 = SystemBase.Base.GridHeadIndex(GHIdx1, "최종납기일");
                        for (int i = 0; i < fpSpread1.Sheets[0].RowCount; i++)
                        {
                            for (int j = 0; j < fpSpread1.Sheets[0].ColumnCount; j++)
                            {
                                ...
                                fpSpread1.Sheets[0].Cells[i, col_idx3].ForeColor = Color.Blue;
                            }
                            // 2016.11.24. hma 추가(Start): 지체일수가 0보다 큰 경우 붉은색 글자로 표시되도록 함.
