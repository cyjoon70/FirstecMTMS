...
namespace AG.ACG405
{
    public partial class ACG405 : UIForm.Buttons
    {
        public ACG405()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACG405_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = "";
                    RptName = SystemBase.Base.ProgramWhere + @"\Report\ACG405.rpt";    // 레포트경로+레포트명
