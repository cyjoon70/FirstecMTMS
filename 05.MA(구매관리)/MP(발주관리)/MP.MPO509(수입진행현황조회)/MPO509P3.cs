...
namespace MP.MPO509
{  
    public partial class MPO509P3 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strBlNo = "";
        #endregion
        ...
        #region Form Load 시
        private void MPO509P3_Load(object sender, System.EventArgs e)
        {  
            //GroupBo x1 초기화
        ...
        #region 그리드조회
        private void Grid_Search(string BlNo)
        {
            this.Cursor = Cursors.WaitCursor;

            try
            {
                string strQuery = "usp_MPO509 @pTYPE = 'P3'";
                strQuery += ", @pBL_NO = '" + BlNo + "'";
                ...
                if (iRow > 0)
                {
                    ...
                    dtpBlReceiptDt.Value = fpSpread1.Sheets[0].Cells[0, SystemBase.Base.GridHeadIndex(GHIdx1, "B/L접수일")].Text;
                    ...
                    {
                        dTotBlAmt += Convert.ToDouble(fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "금액")].Text);
                    }
