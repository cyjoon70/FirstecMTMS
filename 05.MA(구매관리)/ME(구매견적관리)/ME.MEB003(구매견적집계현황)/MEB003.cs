...
namespace ME.MEB003
{
    public partial class MEB003 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void MEB003_Load(object sender, System.EventArgs e)
        {
            //GroupBox1 초기화
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                try
                {
                    ...
                    string strQuery = " usp_MEB003  @pTYPE = 'S1'";
        ...
        private void Set_Span()
        {
            ...
            for (int i = 0; i < iCnt; i++)
            {
                ...
                if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "견적의뢰번호")].Text == "")
                {
                    ...
                    {
                        // 합계 소계 색 변경
                        if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "구매요청번호")].Text == "합계")
                    ...
                    fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "구매요청번호")].RowSpan = i - iRow;
                    fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "품목수")].RowSpan = i - iRow;
                    iRow = i + 1;
                }
