#region 작성정보
/********************************************************************************/
// 단위업무명:  프로젝트별수불집계표(자동입출고제외)(회계)
// 작 성 자  :  한 미 애
// 작 성 일  :  2018-10-26
// 작성내용  :  프로젝트별수불집계표(자동입출고제외)(ITR112)를 복사하여 수정함.
//              구매입고 프로젝트변경 데이터와 프로젝트변경에 의해 생성된 재고이동
//              데이터를 포함하여 집계한 결과를 조회한다.
// 수 정 일  :
// 수 정 자  :
// 수정내용  :
// 비    고  :
...
namespace IT.ITR121
{
    public partial class ITR121 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void ITR121_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void ITR121_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void ITR121_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
