...
namespace DA.DAA002
{
    public partial class DAA002P99 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P99 
        public DAA002P99(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P99_Load
        private void DAA002P99_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > ERROR 로그";
        }
        #endregion
        ...
        #region DAA002P99_Shown 조회
        private void DAA002P99_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
