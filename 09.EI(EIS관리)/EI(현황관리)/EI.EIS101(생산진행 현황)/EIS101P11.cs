...
namespace EI.EIS101
{
    public partial class EIS101P11 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjNo = "";
        string strProjSeq = "";
        ...
        public EIS101P11(string P_No, string P_Seq, string P_item, string Gi_Dt)
        {
            //
        ...
        #region Form Load 시
        private void EIS101P11_Load(object sender, System.EventArgs e)
        {
            this.Text = "생산투입 준수율";
            ...
            //			coll1[2].PointData.Clear();
            //			coll1[3].PointData.Clear();
            //			coll1[4].PointData.Clear();
            //			coll1[5].PointData.Clear();


            //			ChartDataSeriesCollection coll2 = c1Chart1.ChartGroups[1].ChartData.SeriesList;
        ...
        private void Search(bool msg)
        {
            ...
            try
            {
                string strQuery = " usp_EIS101  @pTYPE = 'S11'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //					BindSeries(c1Chart1, 0, dv, "품목수",   "구분");					
                    //					BindSeries(c1Chart1, 1, dv, "요구일내투입");				
                    //					BindSeries(c1Chart1, 2, dv, "요구일후투입");					
                    //					BindSeries(c1Chart1, 3, dv, "미투입" );			
                    BindSeries(c1Chart1, 0, dv, "투입율", "구분");
                    BindSeries(c1Chart1, 1, dv, "투입준수율");
                }
            }
            catch (Exception f)
            {
