...
namespace CW.CWAA04
{
    public partial class CWAA04 : UIForm.FPCOMM1
    {
        #region 변수선언       
        ...
        #region Form Load 시
        private void CWAA04_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_CWAA04 @pTYPE = 'S1'";
        ...
        private void Set_Section()
        {
            ...
            for (int i = 3; i < 15; i++)
            {
                string strDtFr = Convert.ToDateTime(dtpWorkDtFr.Text + "-01").AddMonths(i - 3).ToString();
