...
namespace AC.ACC003
{
    public partial class ACC003 : UIForm.Buttons
    {
        public ACC003()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACC003_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void NewExec()
        {
            ...
            dtpApDtFr.Text = YYMMDD.Substring(0, 7) + "-01";
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = SystemBase.Base.ProgramWhere + @"\Report\ACC003.rpt";    // 레포트경로+레포트명
