...
namespace MX.MEX103
{  
    public partial class MEX102P3 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void MEX102P3_Load(object sender, System.EventArgs e)
        { 
            //GroupBo x1 초기화
            ...
            dtpReportDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString().Substring(0,10);
            dtpReportDtTo.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).ToShortDateString().Substring(0,10);
        ...
        private void Grid_Search(bool Msg)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_MEX102 @pTYPE = 'P3'";
        ...
        {
            RtnStr(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "통관번호")].Text);
