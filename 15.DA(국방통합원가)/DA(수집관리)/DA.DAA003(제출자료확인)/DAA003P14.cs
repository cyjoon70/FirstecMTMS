...
namespace DA.DAA003
{
    public partial class DAA003P14 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P14()
        public DAA003P14(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P14_Load
        private void DAA003P14_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "소재구입선")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D016', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 1);

                FrozenCol = 5; // 고정컬럼(품명까지)

                strSql = " usp_DAA003_설물부품  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P14_Shown
        private void DAA003P14_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
