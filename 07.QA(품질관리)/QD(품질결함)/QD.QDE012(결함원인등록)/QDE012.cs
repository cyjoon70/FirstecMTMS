...
namespace QD.QDE012
{
    public partial class QDE012 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        #endregion
        ...
        public QDE012(string InspReqNo)
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void QDE012_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strDcauEntYn = "";
                    if (rdoDcauEntYnNo.Checked == true)
                    { strDcauEntYn = "N"; }

                    string strQuery = " usp_QDE012  @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pDCAU_ENT_YN = '" + strDcauEntYn + "'";
        ...
        private void butUpdate_Click(object sender, EventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                QDE012P1 myForm = new QDE012P1(fpSpread1, iRow
