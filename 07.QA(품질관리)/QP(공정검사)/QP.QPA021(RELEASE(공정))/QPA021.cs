...
namespace QP.QPA021
{
    public partial class QPA021 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        public QPA021(string param1, string param2, string param3, string param4)
        {
            strInspReqNo = param1;
            strPlantCd = param2;
            strInspReqDt = param3;
        ...
        #region Form Load시
        private void QPA021_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            strJumpFileName1 = "QP.QPA012.QPA012"; //호출할 화면명

            lnkJump2.Text = "검사판정";  //화면에 보여지는 링크명
            strJumpFileName2 = "QP.QPA011.QPA011"; //호출할 화면명
        ...
        private void Grid_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QPA021  @pTYPE = 'S1'";
        ...
        private void SubSearch(int iRow)
        {
            ...
            txtWorkorderNo.Value = fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "제조오더번호")].Text;
            txtRoutNo.Value = fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "라우팅번호")].Text;
            txtRoutNm.Value = fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "라우팅명")].Text;
            txtProcSeq.Value = fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "공정순번")].Text;
            txtProcSeqNm.Value = fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "공정명")].Text;
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", true))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    string strSql = " usp_QPA021 '" + strGbn + "'";
