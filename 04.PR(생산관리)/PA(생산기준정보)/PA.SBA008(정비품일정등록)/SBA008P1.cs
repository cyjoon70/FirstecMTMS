...
namespace PA.SBA008
{  
    public partial class SBA008P1 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void SBA008P1_Load(object sender, System.EventArgs e)
        { 
            //GroupBo x1 초기화
            ...
            dtpSoDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString().Substring(0, 10);
            dtpSoDtTo.Text = SystemBase.Base.ServerTime("YYMMDD").Substring(0, 10);

            this.Text = "수주 참조 조회";
            //lblFormName.Text = "수주 참조 조회";
        ...
        private void Search(bool Msg)
        {
            ...
            try
            {
                string strQuery = " usp_SBA008  @pTYPE = 'S3'";
