...
namespace AD.ACD001
{
    public partial class ACD001P4 : UIForm.Buttons
    {
        #region 변수선언
        DataTable Dt = null;
        string strCUR_CD = "";
        ...
        public ACD001P4(DataTable Loan_Dt, string CUR_CD, string LOAN_NO, string LOAN_DT, string ACCT_CD)
        {
            Dt = Loan_Dt;
            strCUR_CD = CUR_CD;
            strLoan_No = LOAN_NO;
        ...
        #region Form Load 시
        private void ACD001P4_Load(object sender, System.EventArgs e)
        {
            try
            {
