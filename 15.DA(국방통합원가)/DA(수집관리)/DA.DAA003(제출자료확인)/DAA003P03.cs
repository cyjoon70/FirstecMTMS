#region DAA003P03 작성 정보
/*************************************************************/
// 단위업무명 : 원가자료 등록 단가표정보 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-10-30
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P03 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P03()
        public DAA003P03(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P03_Load
        private void DAA003P03_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "공장코드")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='REL1', @pCODE = 'D006', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "', @pSPEC1 = '" + cboM_MNUF_CODE.SelectedValue.ToString() + "'", 0);
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "입고기준")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D020', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "투입기준")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D020', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);

                //FrozenCol = 5; // 고정컬럼(품목/구입선구분)

                strSql = " usp_DAA003_단가정보";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P03_Shown
        private void DAA003P03_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
