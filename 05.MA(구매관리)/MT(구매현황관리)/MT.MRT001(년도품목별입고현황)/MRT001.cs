...
namespace MT.MRT001
{
    public partial class MRT001 : UIForm.FPCOMM1
    {
        public MRT001()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void MRT001_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_MRT001 @pTYPE = '" + strGbn + "'";
        ...
        private void Set_Section()
        {
            ...
            for (int i = 0; i < iCnt; i++)
            {
                ...
                if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목")].Text == "합계")
                {
                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목")].ColumnSpan = 2;
                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목")].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
