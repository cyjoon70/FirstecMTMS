#region 작성정보
/*********************************************************************/
// 단위업무명 : 출고현황집계/상세(주문처별)
// 작 성 자 : 권순철
// 작 성 일 : 2013-04-05
// 작성내용 : 출고현황집계/상세(주문처별) 및 관리
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace SF.SFB010
{
    public partial class SFB010 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void SFB010_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_SFB010 @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pSHIP_CUST = '" + txtCustCd.Text + "'";
        ...
        private void SubSearch(int iRow)
        {
            ...
            string strQuery = "usp_SFB010 @pTYPE = 'S2'";
            strQuery += ", @pSHIP_CUST = '" + fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "주문처")].Text + "'";
