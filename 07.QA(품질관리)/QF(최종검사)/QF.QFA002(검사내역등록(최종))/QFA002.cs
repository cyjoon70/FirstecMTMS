...
namespace QF.QFA002
{
    public partial class QFA002 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public QFA002(string param1, string param2, string param3, string param4)
        {
            //
        ...
        #region Form Load시
        private void QFA002_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void DeleteExec()
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                if (dsMsg == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        string strDelSql = " usp_QFA002  'D2'";
        ...
        private void Grid3_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QFA002  @pTYPE = 'S1'";
        ...
        private void Grid2_Search(int iRow)
        {
            ...
            txtFinInspLvl.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "최종검사레벨")].Text;
            txtFinInspLvlNm.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "최종검사레벨명")].Text;
            ...
            try
            {
                string strQuery = " usp_QFA002  @pTYPE = 'S2'";
        ...
        private void Grid1_Search1()
        {
            ...
            try
            {
                string strQuery = " usp_QFA002  @pTYPE = 'S3'";
                strQuery += ", @pINSP_REQ_NO = '" + txtInspReqNo.Text + "'";
                strQuery += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "'";
                strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'";
                            ...
                            if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                            {
                                ...
                                for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                                {
                                    ...
                                    if (strHead.Length > 0)
                                    {
                                        ...
                                        if (strGbn != "")
                                        {
                                            string strSql = " usp_QFA002 '" + strGbn + "'";
                                            ...
                                            strSql += ", @pFIN_INSP_LVL = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "검사레벨")].Value + "' ";
        ...
        #region 품목사진 뷰어
        private void bntITEM_PICTURE_Click(object sender, EventArgs e)
        {
