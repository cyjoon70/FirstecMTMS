...
namespace HC.HCA012
{
    public partial class HCA012 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strEmpNo = "";
        #endregion
        ...
        #region Form Load시
        private void HCA012_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            //콤보박스 세팅
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "사용구분")] = SystemBase.ComboMake.ComboOnGrid("usp_H_COMMON @pTYPE = 'H007', @pCOM_CD = 'H0138' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0);//사용구분
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_HCA012  @pTYPE = 'S1', @pYY = '" + dtpYear.Text + "', @pEMP_NO = '" + txtEmpNo.Text + "' ";
                    ...
                    if (fpSpread1.Sheets[0].Rows.Count > 0)
                    {
                        ...
                        {
                            UIForm.FPMake.grdReMake(fpSpread1, i, SystemBase.Base.GridHeadIndex(GHIdx1, "사용구분") + "|3"
                ...
                try
                {
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead.Length > 0)
                        {
                            ...
                            string strSql = " usp_HCA012 @pTYPE = '" + strGbn + "' ";
                            ...
                            strSql = strSql + ", @pUSE_TYPE = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "사용구분")].Value + "'";
                            strSql = strSql + ", @pUSE_AMT = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "금액")].Value + "'";
        ...
        protected override void fpButtonClick(int Row, int Column)
        {
            ...
            {
                string strQuery = " usp_H_COMMON 'H005', @pSPEC1 = '" + txtEmpNo.Text + "', @pSPEC2 = '" + dtpYear.Text + "', @pSPEC3 = 'CARD' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        protected override void fpSpread1_ChangeEvent(int Row, int Column)
        {
            ...
            {
                string strQuery = " usp_H_COMMON 'H006', @pSPEC1 = '" + txtEmpNo.Text + "', @pSPEC2 = '" + dtpYear.Text + "', @pSPEC3 = 'CARD' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show(SystemBase.Base.MessageRtn("신용카드 여부가 'N'이거나 존재하지 않는 가족성명입니다."), SystemBase.Base.MessageRtn("Z0003"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
            }
        }
