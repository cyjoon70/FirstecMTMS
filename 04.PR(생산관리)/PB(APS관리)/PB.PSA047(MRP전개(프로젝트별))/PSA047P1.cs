...
namespace PB.PSA047
{ 
    public partial class PSA047P1 : Form
    {
        Thread th;
        string LANGCD = "";
        string COMCD = "";
        ...
        #region 폼로드 이벤트
        private void PSA047P1_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        #region 닫기
        private void PSA047P1_FormClosing(object sender, FormClosingEventArgs e)
        {
            th.Abort();
        }
        #endregion  
