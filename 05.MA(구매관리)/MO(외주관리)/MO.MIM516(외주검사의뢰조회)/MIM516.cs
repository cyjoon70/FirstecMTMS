...
namespace MO.MIM516
{
    public partial class MIM516 : UIForm.FPCOMM1
    {
        public MIM516()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void MIM516_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            SystemBase.ComboMake.C1Combo(cboItemType, "usp_MIM516 @pType='P2', @pLANG_CD = '" + SystemBase.Base.gstrLangCd.ToString() + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0); //품목구분

            // 2019.01.14. hma 추가: 검사판정 항목
            SystemBase.ComboMake.C1Combo(cboInspDecs, "usp_MIM516 @pType='P3', @pLANG_CD = '" + SystemBase.Base.gstrLangCd.ToString() + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0); //품목구분
            ...
            dtpReportDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString();
            dtpReportDtTo.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).ToShortDateString();
            dtpReleaseDtFr.Text = "";
            dtpReleaseDtTo.Text = "";
        ...
        private void btnMvmtNo_Click(object sender, System.EventArgs e)
        {
            try
            {
                WNDW006 pu = new WNDW006(txtWorkorder_No.Text);
                pu.ShowDialog();
                if (pu.DialogResult == DialogResult.OK)
                {
                    string[] Msgs = pu.ReturnVal;

                    txtWorkorder_No.Text = Msgs[1].ToString();
                    txtWorkorder_No.Focus();
                }
            }
            catch (Exception f)
            {
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    ...
                    string strQuery = "usp_MIM516 @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pWORKORDER_NO = '" + txtWorkorder_No.Text + "'";
                    ...
                    strQuery += ", @pPUR_DUTY = '" + txtPurDuty.Text + "'";         // 2017.07.13. CWL 추가: 구매담당자 조회 조건 추가
                    strQuery += ", @pINSP_DEC_FLAG = '" + cboInspDecs.SelectedValue + "'";     // 2019.01.14. hma 추가: 검사판정
