...
namespace AE.ACE027
{
    public partial class ACE027 : UIForm.FPCOMM1
    {
        string strREORG_ID = "";
        int jobColStartIdx = 8;
        int jobColEndIdx = 18;
        ...
        #region Form Load 시
        private void ACE027_Load(object sender, System.EventArgs e)
        {
        ...
        {
            string strQuery = " usp_ACE027 @pTYPE = 'S1', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
            ...
            if (txtAcctCd.Text != "")
            {
                strQuery += ", @pACCT_CD_FR = '" + txtAcctCd.Text + "' ";
            }
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    {
                       if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "계정명")].Text == "합 계")
                        {
        ...
        // 계정코드To 검색버튼 클릭 이벤트. 계정코드 팝업창 띄우기
