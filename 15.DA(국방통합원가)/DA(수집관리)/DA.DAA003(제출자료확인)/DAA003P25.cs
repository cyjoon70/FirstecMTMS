...
namespace DA.DAA003
{
    public partial class DAA003P25 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P25()
        public DAA003P25(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P25_Load
        private void DAA003P25_Load(object sender, EventArgs e)
        {
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D027', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
        ...
        #region DAA003P25_Shown
        private void DAA003P25_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
