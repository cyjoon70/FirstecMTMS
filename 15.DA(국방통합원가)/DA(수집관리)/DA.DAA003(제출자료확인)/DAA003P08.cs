#region DAA003P08 작성 정보
/*************************************************************/
// 단위업무명 : 반제품비 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-05
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P08 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P08()
        public DAA003P08(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P08_Load
        private void DAA003P08_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P08_Shown
        private void DAA003P08_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
