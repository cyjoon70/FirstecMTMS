#region DAA003P12 작성 정보
/*************************************************************/
// 단위업무명 : 수입부품비 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-05
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P12 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P12()
        public DAA003P12(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P12_Load
        private void DAA003P12_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P12_Shown
        private void DAA003P12_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
