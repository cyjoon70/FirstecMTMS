...
namespace AD.ACD004
{
    public partial class ACD004P2 : UIForm.FPCOMM2
    {
        #region 변수선언
        DataTable Dt = null;
        string strCUR_CD = "";
        ...
        public ACD004P2(DataTable Ar_Dt, string CUR_CD, string CUST_CD, string BIZ_AREA_CD, string ACCT_CD, string ACCT_NM)
        {
            Dt = Ar_Dt;
            strCUR_CD = CUR_CD;
            strCustCd = CUST_CD;
        ...
        #region Form Load 시
        private void ACD004P2_Load(object sender, System.EventArgs e)
        {
            try
            {
