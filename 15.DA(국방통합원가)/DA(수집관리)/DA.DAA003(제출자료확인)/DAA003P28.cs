...
namespace DA.DAA003
{
    public partial class DAA003P28 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P28()
        public DAA003P28(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P28_Load
        private void DAA003P28_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='REL1', @pCODE = 'D024', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "', @pSPEC4 = 'Y'", 0);
        ...
        #region DAA003P28_Shown
        private void DAA003P28_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
