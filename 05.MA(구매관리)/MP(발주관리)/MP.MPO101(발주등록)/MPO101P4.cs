...
namespace MP.MPO101
{
    public partial class MPO101P4 : UIForm.FPCOMM1
    {
        #region 변수선언
        string returnVal;
        string strPoNo;
        ...
        public MPO101P4(FarPoint.Win.Spread.FpSpread spread, string PoNo)
        {
            InitializeComponent();
            spd = spread;
            strPoNo = PoNo;
        ...
        #region 폼로드 이벤트
        private void MPO101P4_Load(object sender, EventArgs e)
        {
            this.Text = "품질증빙 일괄적용";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = "usp_MPO101  @pTYPE = 'P4'";
