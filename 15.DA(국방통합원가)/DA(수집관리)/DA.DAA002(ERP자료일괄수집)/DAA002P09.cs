...
namespace DA.DAA002
{
    public partial class DAA002P09 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P09 값 받아올 시
        public DAA002P09(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P09_Load
        private void DAA002P09_Load(object sender, EventArgs e)
        {
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목코드")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA014'", 0);
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "상각방법")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA012'", 0);
            
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 기타경비";
        }
        #endregion
        ...
        #region DAA002P09_Shown 조회
        private void DAA002P09_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion

        #region  거래처 검색 팝업 이벤트
        private void fpSpread1_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            try
            {
                #region 자료등록
                if (e.Column == SystemBase.Base.GridHeadIndex(GHIdx1, "검색"))
                {
