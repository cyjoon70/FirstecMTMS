...
namespace AG.ACG403
{
    public partial class ACG403 : UIForm.Buttons
    {
        public ACG403()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACG403_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    {
                        RptName = SystemBase.Base.ProgramWhere + @"\Report\ACG403_1.rpt";    // 레포트경로+레포트명
                    }
                    else
                    {
                        RptName = SystemBase.Base.ProgramWhere + @"\Report\ACG403_2.rpt";    // 레포트경로+레포트명
                    }
