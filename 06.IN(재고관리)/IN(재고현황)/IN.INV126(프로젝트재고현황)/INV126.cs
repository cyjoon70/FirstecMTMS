...
namespace IN.INV126
{
    public partial class INV126 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void INV126_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery1 = " usp_INV126 'S1'";
                    ...
                    if (rdoStockAll.Checked == true)
                        strQuery2 += ", @pSTOCK_YN ='N'";
                    else if (rdoStockZero.Checked == true)
                        strQuery2 += ", @pSTOCK_YN ='Y'";
                    ...
                    fpSpread1.Sheets[0].SetColumnMerge(0, FarPoint.Win.Spread.Model.MergePolicy.Always);
                    ...
                    //fpSpread1.Sheets[0].SetRowMerge(-1, FarPoint.Win.Spread.Model.MergePolicy.Restricted);
        ...
        private void INV126_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void INV126_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
