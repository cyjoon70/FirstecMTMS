#region DAA003P19 작성 정보
/*************************************************************/
// 단위업무명 : 직접노무비 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-05
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P19 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P19
        public DAA003P19(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P19_Load
        private void DAA003P19_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                FrozenCol = SystemBase.Base.GridHeadIndex(GHIdx1, "레벨"); // 고정컬럼

                strSql = " usp_DAA003_직접노무비  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P19_Shown
        private void DAA003P19_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
