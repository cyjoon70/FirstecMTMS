...
namespace QR.QRA001
{
    public partial class QRA001 : UIForm.FPCOMM2
    {
        #region 변수선언
        string strInspReqNo = "";
        int SearchRow = 0;
        ...
        public QRA001(string param1, string param2, string param3, string param4)
        {
            strInspReqNo = param1;
            strPlantCd = param2;
            strInspReqDt = param3;
        ...
        #region Form Load 시
        private void QRA001_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            lnkJump4.Text = "검사판정";  //화면에 보여지는 링크명
            strJumpFileName4 = "QR.QRA011.QRA011"; //호출할 화면명

            lnkJump5.Text = "불량유형등록";  //화면에 보여지는 링크명
            strJumpFileName5 = "QR.QRA003.QRA003"; //호출할 화면명

            lnkJump6.Text = "검사내역등록";  //화면에 보여지는 링크명
            strJumpFileName6 = "QR.QRA002.QRA002"; //호출할 화면명
        }
        #endregion
        ...
        protected override void Link6Exec()
        {
            param = Params();

            SystemBase.Base.RodeFormID = "QRA002";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "검사내역등록(수입)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        #endregion
        ...
        private void Grid2_Search()
        {
            ...
            try
            {
                string strQuery = " usp_QRA001  @pTYPE = 'S1'";
        ...
        private void Grid1_Search(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QRA001  @pTYPE = 'S2'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    string strSql = " usp_QRA001 '" + strGbn + "'";
        ...
        private void fpSpread1_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            ...
            if (e.Column == SystemBase.Base.GridHeadIndex(GHIdx1, "검사항목_2"))
            {
                try
                {
                    string strQuery = " usp_QINSP_ITEM_CALL @pType='P1', @pINSP_REQ_NO ='" + txtInspReqNo.Text + "', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void btnInspBase_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_QRA001  @pTYPE = 'R1'";
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    string strQuery2 = " usp_QRA001  @pTYPE = 'R2'";
