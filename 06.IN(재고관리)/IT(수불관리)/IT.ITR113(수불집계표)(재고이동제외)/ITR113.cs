...
namespace IT.ITR113
{
    public partial class ITR113 : UIForm.FPCOMM1
    {
        ...
        #region Form Load 시
        private void ITR113_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void btnPreview_Click(object sender, System.EventArgs e)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                string RptName = SystemBase.Base.ProgramWhere + @"\Report\ITR113.rpt";    // 레포트경로+레포트명
        ...
        private void ITR113_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void ITR113_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
