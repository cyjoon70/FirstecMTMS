...
namespace AD.ACD001
{
    public partial class ACD001P1 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void ACD001P1_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    // 2022.02.11. hma 추가(Start): 반제승인여부 
                    if (rdoMinusConfirmY.Checked == true)
                        strQuery += ", @pMINUS_CONFIRM_YN = 'Y' ";
                    else if (rdoMinusConfirmN.Checked == true)
                        strQuery += ", @pMINUS_CONFIRM_YN = 'N' ";
                    // 2022.02.11. hma 추가(End)
        ...
        #region 엔터키 조회
        private void ACD001P1_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
