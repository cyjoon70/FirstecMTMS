...
try
{
    WNDW.ACD007P5 pu = new WNDW.ACD007P5(txtSLIP_NO.Text);
    pu.ShowDialog();
}
catch (Exception f)
{
...
namespace AD.ACD007
{
    ...
    /// </summary>
    public partial class ACD007P5 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public ACD007P5(string SLIP_NO, string ADMIN_YN, string FINANCE_YN)
        {
            strSLIPNO = SLIP_NO;
        ...
        private void ACD007P5_FormClosing(object sender, FormClosingEventArgs e)
        {
