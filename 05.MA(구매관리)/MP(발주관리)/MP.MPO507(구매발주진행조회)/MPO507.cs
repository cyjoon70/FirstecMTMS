...
namespace MP.MPO507
{
    public partial class MPO507 : UIForm.FPCOMM1
    {
        #region 생성자
        public MPO507()
        {
        ...
        #region Form Load 시
        private void MPO507_Load(object sender, System.EventArgs e)
        {
            //필수체크
            SystemBase.Validation.GroupBox_Setting(groupBox1);

            SystemBase.ComboMake.C1Combo(cboPoType, "usp_B_COMMON @pTYPE = 'TABLE', @pCODE = 'PO_TYPE_CD', @pNAME = 'PO_TYPE_NM', @pSPEC1 = 'M_PO_TYPE', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 3);
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_MPO507 @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pPO_TYPE = '" + Convert.ToString(cboPoType.SelectedValue) + "'";
