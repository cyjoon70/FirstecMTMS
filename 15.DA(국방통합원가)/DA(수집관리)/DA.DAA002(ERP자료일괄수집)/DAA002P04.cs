...
namespace DA.DAA002
{
    public partial class DAA002P04 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P04
        public DAA002P04(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P04_Load
        private void DAA002P04_Load(object sender, EventArgs e)
        {
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "인도조건")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA030'", 0);
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "운송구분")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA031'", 0);

             this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 환산율 및 환산단가";
        }
        #endregion
        ...
        #region DAA002P04_Shown()
        private void DAA002P04_Shown(object sender, EventArgs e)
        {            
            SearchExec();
        }
        #endregion
