#region 작성정보
/*********************************************************************/
// 단위업무명 : 구입의뢰서출력(갑/을-소모품)
// 작 성 자 : 이 태 규
// 작 성 일 : 2013-02-14
// 작성내용 : 구입의뢰서출력(갑/을-소모품) 및 관리
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace MR.MRQ506
{
    public partial class MRQ506 : UIForm.Buttons
    {
        #region 생성자
        public MRQ506()
        {
        ...
        #region Form Load시
        private void MRQ506_Load(object sender, System.EventArgs e)
        {
            //필수 체크
        ...
        private void btnReqNo_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                string strQuery = "usp_MRQ505 @pTYPE = 'C3', @pCFM = '1' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
