...
namespace EM.EMR008
{
    public partial class EMR008 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void EMR008_Load(object sender, System.EventArgs e)
        {
        ...
        private void EMR008_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProjectNo.Focus();
        }

        private void EMR008_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
