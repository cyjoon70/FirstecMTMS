...
namespace QD.QDE014
{
    public partial class QDE014P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        string strCfm = "";
        ...
        public QDE014P2(string InspReqNo)
        {
            InitializeComponent();
        ...
        public QDE014P2(string InspReqNo, string cfm_yn)
        {
            InitializeComponent();
        ...
        #region 폼로드 이벤트
        private void QDE014P2_Load(object sender, System.EventArgs e)
        {
            this.Text = "알리미등록";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = " usp_QDE014  @pTYPE = 'P3'";
                ...
                try
                {
                    ...
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead.Length > 0)
                        {
                            ...
                            string strSql = " usp_QDE014 '" + strGbn + "'";
