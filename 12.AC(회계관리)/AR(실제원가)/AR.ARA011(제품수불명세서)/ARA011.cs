...
namespace AR.ARA011
{
    public partial class ARA011 : UIForm.FPCOMM1
    {
        #region 변수선언       
        ...
        #region Form Load 시
        private void ARA011_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    string strQuery = " usp_ARA011 ";
                    strQuery += "  @pTYPE = 'S1' ";
                    strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                    strQuery += ", @pPROJECT_NO ='" + txtProject_No.Text + "'";
                    strQuery += ", @pPROJECT_SEQ ='" + txtProjectSeq.Text + "'";
                    strQuery += ", @dTRAN_DT_FR  ='" + mskDT_Fr.Text + "'";
                    strQuery += ", @dTRAN_DT_TO  ='" + mskDT_To.Text + "'";
