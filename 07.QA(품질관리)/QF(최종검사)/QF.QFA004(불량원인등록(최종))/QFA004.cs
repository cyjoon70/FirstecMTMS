...
namespace QF.QFA004
{
    public partial class QFA004 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public QFA004(string param1, string param2, string param3, string param4)
        {
            //
        ...
        #region Form Load시
        private void QFA004_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            //그리드콤보박스 세팅
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "불량원인")] = SystemBase.ComboMake.ComboOnGrid("usp_Q_COMMON @pType='Q060', @pCODE = 'F', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0);//불량원인
            ...
            strJumpFileName1 = "QF.QFA011.QFA011"; //호출할 화면명
        ...
        protected override void RowInsExec()
        {
            if (fpSpread2.Sheets[0].Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    fpSpread1.Sheets[0].Cells[fpSpread1.Sheets[0].ActiveRowIndex, SystemBase.Base.GridHeadIndex(GHIdx1, "불량유형불량수")].Text = fpSpread2.Sheets[0].Cells[iRow2, SystemBase.Base.GridHeadIndex(GHIdx2, "불량수")].Text;
                    fpSpread1.Sheets[0].Cells[fpSpread1.Sheets[0].ActiveRowIndex, SystemBase.Base.GridHeadIndex(GHIdx1, "불량유형")].Text = fpSpread2.Sheets[0].Cells[iRow2, SystemBase.Base.GridHeadIndex(GHIdx2, "불량유형코드")].Text;
        ...
        private void Grid_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QFA004  @pTYPE = 'S1'";
        ...
        private void SubSearch1(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QFA004  @pTYPE = 'S2'";
        ...
        private void SubSearch2(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QFA004  @pTYPE = 'S3'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    if (strGbn != "")
                                    {
                                        string strSql = " usp_QFA004 '" + strGbn + "'";
        ...
        protected override void fpSpread1_ChangeEvent(int Row, int Column)     
        {
            ...
            if (Column == SystemBase.Base.GridHeadIndex(GHIdx1, "불량수"))
            {
                ...
                if (fpSpread1.Sheets[0].Rows.Count > 0)
                {
                    if (Convert.ToDouble(fpSpread1.Sheets[0].Cells[Row, SystemBase.Base.GridHeadIndex(GHIdx1, "불량유형불량수")].Value)
