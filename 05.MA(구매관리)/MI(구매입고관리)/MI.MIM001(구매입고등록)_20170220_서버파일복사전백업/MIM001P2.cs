...
namespace MI.MIM001
{ 
    public partial class MIM001P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strBtn = "N";
        string returnVal;
        ...
        #region Form Load 시
        private void MIM001P2_Load(object sender, System.EventArgs e)
        {
            this.Text = "발주번호팝업";
            ...
            SystemBase.ComboMake.C1Combo(cboPoType, "usp_M_COMMON @pTYPE = 'M029', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 9);
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = " usp_MIM001  @pTYPE = 'P2'";
        ...
        private void txtPurDuty_Leave(object sender, System.EventArgs e)
        {
            ...
            {
                string temp = "";
                temp = SystemBase.Base.CodeName("PUR_DUTY", "PUR_DUTY", "M_PUR_DUTY", txtPurDuty.Text, " AND USE_YN = 'Y' AND CO_CD = '" + SystemBase.Base.gstrCOMCD + "' AND CO_CD = '" + SystemBase.Base.gstrCOMCD + "' ");
                if (temp != "")
                    txtPurDutyNm.Text = SystemBase.Base.CodeName("USR_ID", "USR_NM", "B_SYS_USER", txtPurDuty.Text, "");
                else
                {
            ...
            try
            {
                if (strBtn == "N" && txtPurDuty.Text.Trim() != "")
                {
                    ...
                    if (temp != "")
                    {
                        if (txtPurDuty.Text != "")
                        {
                            txtPurDutyNm.Value = SystemBase.Base.CodeName("USR_ID", "USR_NM", "B_SYS_USER", txtPurDuty.Text, "");
                        }
                        else
                        {
                            txtPurDutyNm.Value = "";
