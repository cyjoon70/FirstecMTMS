...
namespace CS.CSB014
{
    public partial class CSB014 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void CSB014_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void CSB014_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) dtpDtFr.Focus();
        }

        private void CSB014_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
