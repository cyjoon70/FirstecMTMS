...
namespace AD.ACD008
{
    public partial class ACD008P1 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void ACD008P1_Load(object sender, System.EventArgs e)
        {
        ...
        #region 엔터키 조회
        private void ACD008P1_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
