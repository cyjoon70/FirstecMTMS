...
namespace QT.QTC013
{
    public partial class QTC013P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region 생성자
        public QTC013P1(string sPlantCd, string sProjectNo, string sProjectSeq, string sLotNo, string sItemCd, string sItemAcct, string sUnit, string sInspQty, string sMvmtNo, string sMvmtSeq)
        {
            strPlantCd = sPlantCd;
        ...
        #region 폼로드 이벤트
        private void QTC013P1_Load(object sender, System.EventArgs e)
        {
