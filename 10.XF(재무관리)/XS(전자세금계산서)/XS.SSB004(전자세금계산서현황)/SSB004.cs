...
namespace XS.SSB004
{
    public partial class SSB004 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void SSB004_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void SSB004_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) dtpIssueDtFr.Focus();
        }

        private void SSB004_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
