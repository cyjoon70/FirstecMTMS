...
namespace CW.CWB014
{
    public partial class CWB014 : UIForm.FPCOMM1
    {
        int lastCol = 30;
        ...
        #region Form Load 시
        private void CWB014_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void Grd_Set()
        {
            ...
            try
            {
                string strQuery = " usp_CWB014  @pTYPE = 'S2', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                string strQuery = " usp_CWB014  @pTYPE = 'S1'";
