...
namespace PC.PSB013
{
    public partial class PSB013 : UIForm.Buttons
    {
        public PSB013()
        {
            InitializeComponent();
        ...
        #region Form Load시
        private void PSB013_Load(object sender, System.EventArgs e)
        {
            //필수 체크
        ...
        protected override void SearchExec()
        {
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    strSql += ", @pPROJ_NO = '" + txtProjectNo.Text + "' ";
                    strSql += ", @pPROJECT_SEQ = '" + txtProjectSeq.Text + "' ";
                    strSql += ", @pGROUP_CD = '" + txtItemCd.Text + "' ";
                    strSql += ", @pMAKEORDER_NO = '" + txtMakeOrderNo.Text + "' ";
