...
namespace PB.PSA010
{
    public partial class PSA010P6 : Form
    {
        // 그리드 정보
        ...
        private void PSA010P6_Load(object sender, EventArgs e)
        {
            if (SystemBase.Base.ProgramWhere.Length > 0)
            {

                string HeadQuery = "";
                string itemFrmId = "PSA010P6"; // 품목 FORM ID
            ...
            // 공정확인조회
            string Query = " usp_PSA010 @pType='C4' ";
