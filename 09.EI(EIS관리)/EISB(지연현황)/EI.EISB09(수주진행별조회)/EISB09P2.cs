...
namespace EI.EISB09
{
    public partial class EISB09P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        public EISB09P2(string PoNo, string ProjectNo, string ProjectSeq, string ItemCd, string ItemNm)
        {
            strPoNo = PoNo;
        ...
        #region Form Load 시
        private void EISB09P2_Load(object sender, System.EventArgs e)
        {
            this.Text = "생산정보참조팝업";
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                try
                {
                    string strQuery = "usp_EISB09 @pTYPE = 'P2'";
