...
namespace MO.MIM518
{  
    public partial class MIM518P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region 생성자
        public MIM518P1(string ProjectNo, string ProjectSeq, string ItemCd, string WoNo)
        {
        ...
        #region Form Load 시
        private void MIM518P1_Load(object sender, System.EventArgs e)
        {
            this.Text = "공정진행현황";
            //GroupBo x1 초기화
            ...
            string Query = " usp_MIM518 @pTYPE = 'S3'";
