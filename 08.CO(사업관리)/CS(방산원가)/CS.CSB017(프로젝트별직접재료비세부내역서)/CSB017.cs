...
namespace CS.CSB017
{
    public partial class CSB017 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void CSB017_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void Set_Span()
        {
            int cnt0 = 1;
            int cnt1 = 1;
            int i1 = SystemBase.Base.GridHeadIndex(GHIdx1, "사업명(품목명)");
            ...
            for (int i = 0; i < fpSpread1.Sheets[0].RowCount; i++)
            {
                ...
                if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품번")].Text.IndexOf("소계") > -1) //소계
                {
                ...
                else if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "사업명")].Text == "합계") //합계
                {
                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "사업명(품목명)")].Text = "합계";
        ...
        private void CSB017_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProject_No.Focus();
        }

        private void CSB017_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
