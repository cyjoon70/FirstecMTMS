#region DAA003P20 작성 정보
/*************************************************************/
// 단위업무명 : 감가상각비(전용) 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-05
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P20 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P20()
        public DAA003P20(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P20_Load
        private void DAA003P20_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            ...
            {
                //D027
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "자산구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D027', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "내용연수구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D028', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "취득구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D029', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);

                FrozenCol = SystemBase.Base.GridHeadIndex(GHIdx1, "자산명"); // 고정컬럼

                strSql = " usp_DAA003_감가상각비전용 ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P20_Shown
        private void DAA003P20_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
