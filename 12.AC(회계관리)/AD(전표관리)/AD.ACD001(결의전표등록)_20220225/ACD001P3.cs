...
namespace AD.ACD001
{
    public partial class ACD001P3 : UIForm.FPCOMM2
    {
        #region 변수선언
        DataTable Dt = null;
        string strCUR_CD = "";
        ...
        public ACD001P3(DataTable Ap_Dt, string CUR_CD, string CUST_CD, string BIZ_AREA_CD, string ACCT_CD, string ACCT_NM)
        {
            Dt = Ap_Dt;
            strCUR_CD = CUR_CD;
            strCustCd = CUST_CD;
        ...
        #region Form Load 시
        private void ACD001P3_Load(object sender, System.EventArgs e)
        {
            try
            {
