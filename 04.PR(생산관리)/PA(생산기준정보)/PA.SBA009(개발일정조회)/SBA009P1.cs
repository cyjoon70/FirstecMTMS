...
namespace PA.SBA009
{ 
    public partial class SBA009P1 : UIForm.FPCOMM1
    {
        #region Form Load 시
        ...
        #region Form Load 시
        private void SBA009P1_Load(object sender, System.EventArgs e)
        { 
            //GroupBo x1 초기화
        ...
        private void Search(bool Msg)
        {
            ...
            try
            {
                string strQuery = " usp_SBA009  @pTYPE = 'S2'";
