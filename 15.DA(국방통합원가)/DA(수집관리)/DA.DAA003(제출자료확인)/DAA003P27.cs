#region DAA003P27 작성 정보
/*************************************************************/
// 단위업무명 : 순매출액경비(원화) 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-05
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P27 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P27()
        public DAA003P27(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P27_Load
        private void DAA003P27_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                FrozenCol = SystemBase.Base.GridHeadIndex(GHIdx1, "비목"); // 고정컬럼(비목 까지)

                strSql = " usp_DAA003_순매출액경비원화  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region
        private void DAA003P27_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
