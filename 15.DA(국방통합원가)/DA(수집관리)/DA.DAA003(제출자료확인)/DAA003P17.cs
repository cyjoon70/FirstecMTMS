...
namespace DA.DAA003
{
    public partial class DAA003P17 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P17()
        public DAA003P17(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P17_Load
        private void DAA003P17_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                FrozenCol = 2; // 고정컬럼(부품관리번호)

                strSql = " usp_DAA003_직접노무량  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P17_Shown
        private void DAA003P17_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
