			...
			if (fpSpread1.Sheets[0].Rows.Count > 0)
			{
				...
				for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
				{
					if (Convert.ToDecimal(fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1,"이동수량")].Value) > 0)
					{
                        ...
                        spd.Sheets[0].Cells[j, 13].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "차수")].Text;			//프로젝트차수    // 2015.12.17. hma 수정: 12=>13
                        spd.Sheets[0].Cells[j, 20].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "창고")].Text;			//창고            // 2015.12.17. hma 수정: 19=>20
                        spd.Sheets[0].Cells[j, 22].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "창고명")].Text;			//창고명          // 2015.12.17. hma 수정: 21=>22
                        spd.Sheets[0].Cells[j, 23].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "위치")].Text;			//창고위치        // 2015.12.17. hma 수정: 22=>23
                        spd.Sheets[0].Cells[j, 25].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "위치명")].Text;			//위치명          // 2015.12.17. hma 수정: 24=>25
                        ...
                        spd.Sheets[0].Cells[j, 31].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "바코드")].Value;			//바코드          // 2015.12.17. hma 수정: 30=>31
                        spd.Sheets[0].Cells[j, 32].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "입고번호")].Value;		//입고번호        // 2015.12.17. hma 수정: 31=>32
                        spd.Sheets[0].Cells[j, 33].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "입고순번")].Value;		//입고순번        // 2015.12.17. hma 수정: 32=>33
                        spd.Sheets[0].Cells[j, 16].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "Lot No")].Value;			//Lot No          // 2015.12.17. hma 수정: 15=>16
                        spd.Sheets[0].Cells[j, 15].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "Lot 추적")].Value;		//Lot 추적 여부   // 2015.12.17. hma 수정: 14=>15
                        spd.Sheets[0].Cells[j, 26].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "출고단가")].Value;		//출고단가(재고단가)    // 2015.12.17. hma 수정: 25=>26
						spd.Sheets[0].Cells[j, 27].Value = 
							Convert.ToDecimal(fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "출고단가")].Value) *
                            Convert.ToDecimal(fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "이동수량")].Value);					//출고금액         // 2015.12.17. hma 수정: 26=>27
                        spd.Sheets[0].Cells[j, 30].Value = fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "재고수량")].Value;		//기존수량         // 2015.12.17. hma 수정: 29=>30
