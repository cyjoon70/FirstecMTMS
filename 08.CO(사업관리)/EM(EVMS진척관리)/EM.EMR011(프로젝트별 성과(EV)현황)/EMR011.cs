...
namespace EM.EMR011
{
    public partial class EMR011 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void EMR011_Load(object sender, System.EventArgs e)
        {
        ...
        private void txtProjectNo_TextChanged(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    txtProjectNm.Value = SystemBase.Base.CodeName("PROJECT_NO", "PROJECT_NM", "S_SO_MASTER", txtProjectNo.Text, " AND CO_CD='" + SystemBase.Base.gstrCOMCD + "'  AND CO_CD='" + SystemBase.Base.gstrCOMCD + "' ");
                }
                else
                {
                    txtProjectNm.Value = "";
        ...
        private void EMR011_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProjectNo.Focus();
        }

        private void EMR011_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
