...
namespace EM.EMR006
{
    public partial class EMR006 : UIForm.FPCOMM2
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void EMR006_Load(object sender, System.EventArgs e)
        {
        ...
        private void EMR006_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProjectNo.Focus();
        }

        private void EMR006_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
