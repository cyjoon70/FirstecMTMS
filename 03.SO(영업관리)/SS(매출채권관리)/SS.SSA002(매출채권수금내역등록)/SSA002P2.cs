...
namespace SS.SSA002
{
    public partial class SSA002P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region 생성자
        public SSA002P2(FarPoint.Win.Spread.FpSpread fpRtrGrid, int Row, string CustCd, string NoteNo)
        {
            fpGrid = fpRtrGrid;
            ActiveRow = Row;
            strCustCd = CustCd;
        ...
        #region 폼로드 이벤트
        private void SSA002P2_Load(object sender, System.EventArgs e)
        {
            ...
            txtNoteNoFr.Value = strNoteNo;
            dtpIssueDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString();
        ...
        private void Search(bool Msg)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                try
                {
                    ...
                    string strQuery = " usp_SSA002  @pTYPE = 'C2' ";
