...
#region 작성정보
/*********************************************************************/
// 단위업무명 : 만기어음CheckList출력
// 작 성 자 : 유 재 규
// 작 성 일 : 2013-03-19
// 작성내용 : 만기어음CheckList출력
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace AG.ACG305
{
    public partial class ACG305 : UIForm.Buttons
    {
        public ACG305()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACG305_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = "";
                    RptName = SystemBase.Base.ProgramWhere + @"\Report\ACG305.rpt";    // 레포트경로+레포트명
                    ...
                    RptParmValue[5] = dtpExpDtFr.Text;
                    RptParmValue[6] = dtpExpDtTo.Text;
                    RptParmValue[7] = txtCustCd.Text;
                    RptParmValue[8] = cboBankCd.SelectedValue.ToString();
                    RptParmValue[9] = cboNoteKind.SelectedValue.ToString();
