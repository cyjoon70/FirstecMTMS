#region DAA003P06 작성 정보
/*************************************************************/
// 단위업무명 : 원가자료 등록 환산율 및 환산가3 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-10-30
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P06 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P06()
        public DAA003P06(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P06_Load
        private void DAA003P06_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P06_Shown
        private void DAA003P06_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
