...
namespace QP.QPA002
{
    public partial class QPA002 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public QPA002(string param1, string param2, string param3, string param4)
        {
            //
        ...
        #region Form Load시
        private void QPA002_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            strJumpFileName1 = "QP.QPA021.QPA021"; //호출할 화면명

            lnkJump2.Text = "부적합처리";  //화면에 보여지는 링크명
            strJumpFileName2 = "QP.QPA012.QPA012"; //호출할 화면명

            lnkJump3.Text = "검사판정";  //화면에 보여지는 링크명
            strJumpFileName3 = "QP.QPA011.QPA011"; //호출할 화면명

            lnkJump4.Text = "불량유형등록";  //화면에 보여지는 링크명
            strJumpFileName4 = "QP.QPA003.QPA003"; //호출할 화면명

            lnkJump5.Text = "검사항목등록";  //화면에 보여지는 링크명
            strJumpFileName5 = "QP.QPA001.QPA001"; //호출할 화면명
        }
        #endregion
        ...
        protected override void Link1Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA021";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "RELEASE(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        protected override void Link2Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA012";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "부적합처리(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        protected override void Link3Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA011";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "검사판정(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        protected override void Link4Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA003";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "불량유형등록(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        protected override void Link5Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA001";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "검사항목등록(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        #endregion
        ...
        protected override void DeleteExec()
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                if (dsMsg == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        string strDelSql = " usp_QPA002  'D2'";
        ...
        private void Grid3_Search()
        {
            ...
            try
            {
                string strQuery = " usp_QPA002  @pTYPE = 'S1'";
        ...
        private void Grid2_Search(int iRow)
        {
            ...
            txtRoutNo.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "라우팅번호")].Text;
            txtRoutNm.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "라우팅명")].Text;
            txtProcSeq.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "공정순번")].Text;
            txtProcSeqNm.Value = fpSpread3.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx3, "공정명")].Text;
            ...
            try
            {
                string strQuery = " usp_QPA002  @pTYPE = 'S2'";
                ...
                if (fpSpread2.Sheets[0].Rows.Count > 0)
                {
                    fpSpread2.Sheets[0].Rows[0, fpSpread2.Sheets[0].RowCount - 1].Height = 30;
                    Grid1_Search1();
            ...
            if (e.Row != e.NewRow)
            {
                if (fpSpread2.Sheets[0].Rows.Count > 0)
                {
                    try
                    {
                        ...
                        txtMap_Coor.Value = fpSpread2.Sheets[0].Cells[e.NewRow, SystemBase.Base.GridHeadIndex(GHIdx2, "도면좌표")].Text;
        ...
        private void Grid1_Search1()
        {
            ...
            try
            {
                string strQuery = " usp_QPA002  @pTYPE = 'S3'";
                            ...
                            if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                            {
                                ...
                                for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                                {
                                    ...
                                    if (strHead.Length > 0)
                                    {
                                        ...
                                        if (strGbn != "")
                                        {
                                            string strSql = " usp_QPA002 '" + strGbn + "'";
        ...
        private void GrdRemake(int iRow)
        {
            if (fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "품질표시")].Text == "1")
            {
               ...
               // UIForm.FPMake.grdReMake(fpSpread1, iRow, "2|3#3|0");  //이전소스
            }
            else
            {
                ...
                //UIForm.FPMake.grdReMake(fpSpread1, iRow, "2|1#3|3");  //이전소스
            }
        }
        #endregion
        ...
        {
            for (int i = 0; i < Convert.ToInt32(txtSampleQty.Value); i++)
            {
                RowInsert();
            }

            fpSpread1.ActiveSheet.SetActiveCell(fpSpread1.Sheets[0].ActiveRowIndex - Convert.ToInt32(txtSampleQty.Value) + 1, 1);
        ...
        private void Grd_Lock()
        {
            ...
            if (strDecisionCd != "N")	//판정
            {
                for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                {
                    ...
                    if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "불량")].Text == "True")
                    {
                        fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "불량")].BackColor = Color.Red;
                    }
                }
                UIForm.Buttons.ReButton("110000001001", BtnNew, BtnSearch, BtnRCopy, BtnRowIns, BtnCancel, BtnDel, BtnDelete, BtnInsert, BtnExcel, BtnPrint, BtnHelp, BtnClose);
            }
        ...
        private void butInspResult_Click(object sender, System.EventArgs e)
        {
            if (txtInspReqNo.Text != "")
            {
                ...
                try
                {
                    //th = new Thread(new ThreadStart(Show_Waiting));   // 2015.05.18. hma 주석처리
                    //th.Start();
                    //Thread.Sleep(200);
                    //Waiting_Form.Activate();
                    this.Cursor = Cursors.WaitCursor;                   // 2015.05.18. hma 추가

                    string strQuery = " usp_QPA002  @pTYPE = 'R1'";
                    strQuery += ", @pINSP_REQ_NO = '" + txtInspReqNo.Text + "' ";
                    strQuery += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                    strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        //Waiting_Form.progressBar_temp.Maximum = dt.Rows.Count;        // 2015.05.18. hma 주석처리
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++) //내용입력
                        {
                            ...
                            //Waiting_Form.progressBar_temp.Value = i + 1;      // 2015.05.18. hma 주석처리

                        }

                        if (dt.Rows[dt.Rows.Count - 1]["UNITY_INSP_REQ_NO"].ToString() != "")
                        {
                            string strQuery3 = " usp_QPA002  @pTYPE = 'R3'";
                        ...
                        //Waiting_Form.label_temp.Text = "완료되었습니다.";    // 2015.05.18. hma 주석처리
                        //Thread.Sleep(500);
                ...
                {
                    //Waiting_Form.Close();     // 2015.05.18. hma 주석처리 
                    //th.Abort();
