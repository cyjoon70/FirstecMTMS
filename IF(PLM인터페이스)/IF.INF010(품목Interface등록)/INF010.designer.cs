namespace IF.INF010
{
    partial class INF010
	{
        ...
        private void InitializeComponent()
        {
			...
			this.Name = "INF010";
			this.Text = "품목정보등록(멀티)";
			this.Load += new System.EventHandler(this.INF010_Load);
