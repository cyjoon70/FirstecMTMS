#region DAA003P23 작성 정보
/*************************************************************/
// 단위업무명 : BOM정보와 단가표정보로 외주가공비 외화 자료를 생성한다.
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-07
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P23 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P23()
        public DAA003P23(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P23_Load
        private void DAA003P23_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P23_Shown
        private void DAA003P23_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
