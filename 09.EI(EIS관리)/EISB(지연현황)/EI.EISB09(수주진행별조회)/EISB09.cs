...
namespace EI.EISB09
{
    public partial class EISB09 : UIForm.FPCOMM1
    {
        #region 생성자
        public EISB09()
        {
        ...
        #region Form Load 시
        private void EISB09_Load(object sender, System.EventArgs e)
        {
            //GroupBox1 초기화
            ...
            ////기타 세팅	
            dtpRefDelvDtTo.Text = SystemBase.Base.ServerTime("YYMMDD");
            dtpRefDelvDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString();
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery = "usp_EISB09 @pTYPE = 'S1'";
                    ...
                    {
                        int col_idx = SystemBase.Base.GridHeadIndex(GHIdx1, "수주량");
        ...
        private void butReqRef_Click(object sender, EventArgs e)
        {
            if (fpSpread1.ActiveSheet.GetSelection(0) != null)
            {
                try
                {
                    ...
                    EISB09P1 myForm = new EISB09P1(strPoNo, strProjectNo, strProjectSeq, strItemCd, strItemNm);
                    myForm.ShowDialog();
                }
                catch (Exception f)
                {
        ...
        private void butMrpRef_Click(object sender, EventArgs e)
        {
            if (fpSpread1.ActiveSheet.GetSelection(0) != null)
            {
                try
                {
                    ...
                    EISB09P2 myForm = new EISB09P2(strPoNo, strProjectNo, strProjectSeq, strItemCd, strItemNm);
                    myForm.ShowDialog();
                }
                catch (Exception f)
                {
