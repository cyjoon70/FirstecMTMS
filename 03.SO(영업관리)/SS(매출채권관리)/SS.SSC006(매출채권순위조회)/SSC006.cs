...
namespace SS.SSC006
{
    public partial class SSC006 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void SSC006_Load(object sender, System.EventArgs e)
        {
            //GroupBox1 초기화
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                try
                {
                    ...
                    if (rdoRankQty.Checked == true)
                        strQuery = " usp_SSC006 'S1'";
                    else
                        strQuery = " usp_SSC006 'S2'";
        ...
        private void SSC006_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) dtpBnDtFr.Focus();
        }

        private void SSC006_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
