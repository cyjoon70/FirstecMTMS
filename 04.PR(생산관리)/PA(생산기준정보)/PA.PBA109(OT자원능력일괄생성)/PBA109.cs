...
namespace PA.PBA109
{
    public partial class PBA109 : UIForm.Buttons
    {
        public PBA109()
        {
            InitializeComponent();
        ...
        #region Form Load시
        private void PBA109_Load(object sender, System.EventArgs e)
        {
            //필수 체크
            ...
            dtpSTARTDT.Text = DateTime.Now.ToShortDateString().Substring(0, 7);
            dtpENDDT.Text = DateTime.Now.ToShortDateString().Substring(0, 7);
        }
        #endregion
        ...
        private void exec()
        {
            ...
            try
            {
                ...
                string strSql = " SELECT TOP 1 CAPA_DT FROM P_RESOURCE_CAPA(NOLOCK) WHERE RES_FLAG = 'O' ";
                ...
                if (dt.Rows.Count == 0 || dsMsg == DialogResult.Yes)
                {
                    ...
                    strSql += ", @pOT_TIME_STD = '" + dtxtOT_TIME_STD.Value + "' ";
                    strSql += ", @pOT_TIME_WED = '" + dtxtOT_TIME_WED.Value + "' ";
                    strSql += ", @pOT_TIME_SAT = '" + dtxtOT_TIME_SAT.Value + "' ";
                    strSql += ", @pOT_TIME_SUN = '" + dtxtOT_TIME_SUN.Value + "' ";
                    strSql += ", @pOT_TIME_HOL = '" + dtxtOT_TIME_HOL.Value + "' ";
