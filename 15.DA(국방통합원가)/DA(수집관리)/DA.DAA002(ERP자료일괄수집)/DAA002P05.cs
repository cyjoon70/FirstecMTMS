...
namespace DA.DAA002
{
    public partial class DAA002P05 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P05
        public DAA002P05(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P05_Load
        private void DAA002P05_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 직접노무량이력";
        }
        #endregion
        ...
        #region DAA002P05_Shown()
        private void DAA002P05_Shown(object sender, EventArgs e)
        {
            SearchExec();
        ...
        private void btnAll_Process_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DAA002P051 pu = new DAA002P051(iPK_SEQ, strMNUF_CODE, strORDR_YEAR, strDPRT_CODE, strDCSN_NUMB, strCALC_DEGR, strFormId);
                pu.Owner = this;
                pu.Show();
            }
            catch (Exception f)
