...
namespace UIForm
{
    public partial class FPCOMM2 : Buttons
    {
        ...
        public string[] G1Etc = new string[200];//null;// Mask 양식 등     // 2018.12.29. hma 수정: 100=>200으로 변경
        ...
        #region FPCOMM1_Load
        private void FPCOMM2_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void FPCOMM2_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        private void FPCOMM2_KeyDown(object sender, KeyEventArgs e)
        {
