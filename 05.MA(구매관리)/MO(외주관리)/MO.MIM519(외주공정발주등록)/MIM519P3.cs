...
namespace MO.MIM519
{
    public partial class MIM519P3 : UIForm.FPCOMM1
    {
        #region 변수선언
        string returnVal;
        string returnStr;
        ...
        public MIM519P3(string PoNo, string PoSeq)
        {
            InitializeComponent();
            strPoNo = PoNo;
            strPoSeq = PoSeq;
        ...
        #region 폼로드 이벤트
        private void MIM519P3_Load(object sender, EventArgs e)
        {
            this.Text = "품질증빙팝업";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = " usp_MIM519  @pTYPE = 'P3'";
        ...
        #region MIM519P3_FormClosing
        private void MIM519P3_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (strState == "Y")
            {
                RtnStr("Y", strTemp);
