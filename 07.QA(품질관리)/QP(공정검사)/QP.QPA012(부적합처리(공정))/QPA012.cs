...
namespace QP.QPA012
{
    public partial class QPA012 : UIForm.FPCOMM2
    {
        #region 변수선언
        string strInspReqNo = "";
        int SearchRow = 0;
        ...
        public QPA012(string param1, string param2, string param3, string param4)
        {
            strInspReqNo = param1;
            strPlantCd = param2;
            strInspReqDt = param3;
        ...
        #region Form Load 시
        private void QPA012_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            //그리드콤보박스 세팅
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "부적합처리")] = SystemBase.ComboMake.ComboOnGrid("usp_Q_COMMON @pType='Q070', @pCODE = 'P', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0); //부적합처리
        ...
        private void Grid_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QPA012  @pTYPE = 'S1'";
        ...
        private void SubSearch(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QPA012  @pTYPE = 'S2'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    string strSql = " usp_QPA012 '" + strGbn + "'";
