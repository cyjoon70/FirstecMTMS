...
namespace DA.DAA002
{
    public partial class DAA002P08 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P08 값 받아올 시
        public DAA002P08(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P08_Load
        private void DAA002P08_Load(object sender, EventArgs e)
        {
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목코드")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA013'", 0);
            
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 감가상각대상경비";
        }
        #endregion
        ...
        #region DAA002P08_Shown 조회
        private void DAA002P08_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
