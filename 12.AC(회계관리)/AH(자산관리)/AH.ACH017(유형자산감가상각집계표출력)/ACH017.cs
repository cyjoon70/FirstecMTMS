...
namespace AH.ACH017
{
    public partial class ACH017 : UIForm.Buttons
    {
        public ACH017()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACH017_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void NewExec()
        {
            ...
            dtpDeprDt.Value = SystemBase.Base.ServerTime("YYMMDD");
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = "";
                    RptName = SystemBase.Base.ProgramWhere + @"\Report\ACH017.rpt";    // 레포트경로+레포트명
                    ...
                    RptParmValue[3] = dtpDeprDt.Text;
                    RptParmValue[4] = cboBizAreaCd.SelectedValue.ToString();
