...
namespace DA.DAA003
{
    public partial class DAA003P29 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P29()
        public DAA003P29(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P29_Load
        private void DAA003P29_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D024', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "매출구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D032', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);

                strSql = " usp_DAA003_순매출액경비공제내역  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P29_Shown
        private void DAA003P29_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
