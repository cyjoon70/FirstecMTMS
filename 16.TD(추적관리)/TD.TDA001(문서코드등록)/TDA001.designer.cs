namespace TD.TDA001
{
    partial class TDA001
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TDA001));
			...
			this.GridCommGroupBox.Size = new System.Drawing.Size(784, 463);
			...
			this.GridCommPanel.Size = new System.Drawing.Size(784, 463);
			// 
			// fpSpread1
			// 
			...
			this.fpSpread1.Size = new System.Drawing.Size(778, 443);
			...
			this.Name = "TDA001";
			this.Text = "문서코드등록";
			this.Load += new System.EventHandler(this.TDA001_Load);
