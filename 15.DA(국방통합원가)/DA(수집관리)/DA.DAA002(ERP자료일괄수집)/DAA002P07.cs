...
namespace DA.DAA002
{
    public partial class DAA002P07 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P07 값 받아올 때
        public DAA002P07(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P07_Load
        private void DAA002P07_Load(object sender, EventArgs e)
        {
            ...
            G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "공정")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA025'", 0);
            
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 지급임차료";
        }
        #endregion
        ...
        #region DAA002P07_Shown 조회
        private void DAA002P07_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
