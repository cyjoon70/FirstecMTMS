...
namespace MT.MRT007
{
    public partial class MRT007 : UIForm.FPCOMM1
    {
        public MRT007()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void MRT007_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            dtpIvDt.Text = SystemBase.Base.ServerTime("Y");
        }
        #endregion
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_MRT007 @pTYPE = 'S1'";
                    strQuery += ", @pIV_DT = '" + dtpIvDt.Text + "'";
