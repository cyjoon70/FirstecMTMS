...
namespace UIForm
{
    public partial class PRINT10 : Form
    {
        #region 변수선언
        ...
        private void LogonToReport(string server, string database, string ID, string password)
        {
            ...
            {
                SystemBase.Loggers.Log("PRINT10_Load", f.ToString());
                MessageBox.Show(SystemBase.Base.MessageRtn("B0050", "(PRINT10) 프린트"), SystemBase.Base.MessageRtn("Z0002"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
