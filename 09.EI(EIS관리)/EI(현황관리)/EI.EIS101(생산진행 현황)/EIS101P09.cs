...
namespace EI.EIS101
{
    public partial class EIS101P09 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjNo = "";
        string strProjSeq = "";
        ...
        public EIS101P09(string P_No, string P_Seq, string P_item, string Gi_Dt)
        {
            //
        ...
        #region Form Load 시
        private void EIS101P09_Load(object sender, System.EventArgs e)
        {
            this.Text = "검사현황";
        ...
        private void Search(bool msg)
        {
            ...
            try
            {
                string strQuery = " usp_EIS101  @pTYPE = 'S09'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //					BindSeries(c1Chart1, 1, dv, "검사완료품");				
                    //					BindSeries(c1Chart1, 2, dv, "검사미완료");					
                    BindSeries(c1Chart1, 0, dv, "합격율", "구분");
                    BindSeries(c1Chart1, 1, dv, "불합격율");
                    BindSeries(c1Chart1, 2, dv, "검사율"); ;
                }
            }
            catch (Exception f)
            {
