...
namespace IT.ITR003
{
    public partial class ITR003P1 : UIForm.FPCOMM1
    {
        ...
        #region 생성자
        public ITR003P1(string item_cd)
        {
            InitializeComponent();
            strItemCd = item_cd;
        }
        ...
        #region 폼로드 이벤트
        private void ITR003P1_Load(object sender, System.EventArgs e)
        {
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
				...
				string strQuery = " usp_ITR003  @pTYPE = 'P1'";
