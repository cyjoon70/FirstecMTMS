#region DAA003P05 작성 정보
/*************************************************************/
// 단위업무명 : 원가자료 등록 각 항목별 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2012-11-02
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P05 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        string strFormId = "";
        string strFormName = "";
        string strESB_BIZNES_TRNSTN_ID = "";
        #endregion
        ...
        #region DAA003P05()
        public DAA003P05(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P05_Load
        private void DAA003P05_Load(object sender, EventArgs e)
        {
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "비목구분")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D034', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 1);
                
                //FrozenCol = 5; // 고정컬럼(품명까지)

                strSql = " usp_DAA003_수입내역  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        private void DAA003P05_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
