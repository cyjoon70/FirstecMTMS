...
namespace PB.PBC101
{
    public partial class PBC101 : UIForm.FPCOMM2
    {
        public PBC101()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void PBC101_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery1 = " usp_PBC101 @pType='S1', ";
        ...
        private void fpSpread2_SelectionChanged(object sender, FarPoint.Win.Spread.SelectionChangedEventArgs e)
        {
            ...
            if (fpSpread2.Sheets[0].Rows.Count > 0)
            {
                try
                {
                    string strQuery1 = " USP_PBC101 'S2', ";
                    strQuery1 += " @pSCH_ID='" + cboSch_id.SelectedValue.ToString() + "', ";
                    strQuery1 += " @pSTART_DT='" + dtpStartDT.Value.ToString().Substring(0, 10) + "', ";
                    strQuery1 += " @pEND_DT='" + dtpEndDT.Value.ToString().Substring(0, 10) + "', ";
