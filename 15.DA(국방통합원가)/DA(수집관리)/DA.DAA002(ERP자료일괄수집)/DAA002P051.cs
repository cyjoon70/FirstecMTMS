...
namespace DA.DAA002
{
    public partial class DAA002P051 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P051
        public DAA002P051(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P051_Load
        private void DAA002P051_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 직접노무량이력상세";
        }
        #endregion
        ...
        #region DAA002P051_Shown()
        private void DAA002P051_Shown(object sender, EventArgs e)
        {
            SearchExec();
