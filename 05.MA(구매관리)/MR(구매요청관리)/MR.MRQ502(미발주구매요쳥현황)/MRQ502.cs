...
namespace MR.MRQ502
{
    public partial class MRQ502 : UIForm.FPCOMM1
    {
        public MRQ502()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void MRQ502_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            dtpReqDtFr.Value = null;
            dtpReqDtTo.Value = null;
        }
        #endregion
        ...
        private void btnPurOrg_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                string[] strSearch = new string[] { txtPurOrg.Text, "" };
                ...
                if (pu.DialogResult == DialogResult.OK)
                {
                    ...
                    txtPurOrg.Text = Msgs[0].ToString();
        ...
        //구매조직
        private void txtPurOrg_TextChanged(object sender, System.EventArgs e)
        {
            txtPurOrgNm.Value = SystemBase.Base.CodeName("MINOR_CD", "CD_NM", "B_COMM_CODE", txtPurOrg.Text, " AND LANG_CD = '" + SystemBase.Base.gstrLangCd + "' AND MAJOR_CD = 'M001' AND COMP_CODE = '" + SystemBase.Base.gstrCOMCD + "'");
        }
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery = "usp_MRQ502 @pTYPE = 'S1'";
                    strQuery += ", @pPUR_ORG = '" + txtPurOrg.Text + "'";
        ...
        private void Set_Section()
        {
            ...
            for (int i = 0; i < iCnt; i++)
            {
                ...
                if (fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품명")].Text == "")
                {

                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "품목코드")].ColumnSpan = 5;
                    fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "구매요청번호")].ColumnSpan = 9;
                    ...
                    fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "품목코드")].RowSpan = i - iRow;
                    fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "품명")].RowSpan = i - iRow;
                    fpSpread1.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx1, "규격")].RowSpan = i - iRow;
