...
namespace PC.PCC041
{
    public partial class PCC041P1 : UIForm.FPCOMM1
    {
        string strProjectNo = "", strProjectSeq = "", strItemCd = "", strWoNo = "";

        public PCC041P1(string ProjectNo, string ProjectSeq, string ItemCd, string WoNo)
        {
        ...
        #region 폼로드 이벤트
        private void PCC041P1_Load(object sender, System.EventArgs e)
        {
            this.Text = "공정진행현황";
            ...
            string Query = " usp_PCC041 @pTYPE = 'S3'";
