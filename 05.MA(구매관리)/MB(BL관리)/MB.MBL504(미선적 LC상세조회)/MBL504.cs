...
namespace MB.MBL504
{
    public partial class MBL504 : UIForm.FPCOMM1
    {     
        public MBL504()
        {
            InitializeComponent();
        ...
        #region Form Load시
        private void MBL504_Load(object sender, System.EventArgs e)
        {
        ...
        private void btnLcNo_Click(object sender, EventArgs e)
        {
            ...
            {
                SystemBase.Loggers.Log(this.Name, f.ToString());
                MessageBox.Show(SystemBase.Base.MessageRtn("B0050", "L/C 번호 팝업"), SystemBase.Base.MessageRtn("Z0002"), MessageBoxButtons.OK, MessageBoxIcon.Error);	//데이터 조회 중 오류가 발생하였습니다.
            }
        }
        #endregion
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_MBL504 @pTYPE = 'S1'";
