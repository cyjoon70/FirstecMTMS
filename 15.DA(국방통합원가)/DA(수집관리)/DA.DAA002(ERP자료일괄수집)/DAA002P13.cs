...
namespace DA.DAA002
{
    public partial class DAA002P13 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P13 
        public DAA002P13(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P13_Load
        private void DAA002P13_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 설물발생액";
        }
        #endregion
        ...
        #region DAA002P13_Shown 조회
        private void DAA002P13_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
