...
namespace CS.CSB026
{
    public partial class CSB026 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void CSB026_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void CSB026_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtProject_No.Focus();
        }

        private void CSB026_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
