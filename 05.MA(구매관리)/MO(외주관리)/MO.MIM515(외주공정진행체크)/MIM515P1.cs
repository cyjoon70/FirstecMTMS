...
namespace MO.MIM515
{  
    public partial class MIM515P1 : UIForm.FPCOMM1
    {
        string strProjectNo = "", strProjectSeq = "", strItemCd = "", strWoNo = "";

        public MIM515P1(string ProjectNo, string ProjectSeq, string ItemCd, string WoNo)
        {
        ...
        #region Form Load 시
        private void MIM515P1_Load(object sender, System.EventArgs e)
        { 
            //GroupBo x1 초기화
            ...
            string Query = " usp_MIM515 @pTYPE = 'S2'";
