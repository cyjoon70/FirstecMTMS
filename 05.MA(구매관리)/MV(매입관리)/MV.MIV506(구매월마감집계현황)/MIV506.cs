...
namespace MV.MIV506
{
    public partial class MIV506 : UIForm.FPCOMM1
    {
        #region 생성자
        public MIV506()
        {
        ...
        #region Form Load 시
        private void MIV506_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void txtCustCdFr_TextChanged(object sender, System.EventArgs e)
        {
            try
            {
                if (txtCustCdFr.Text != "")
                {
                    txtCustNmFr.Value = SystemBase.Base.CodeName("CUST_CD", "CUST_NM", "B_CUST_INFO", txtCustCdTo.Text, " AND CO_CD = '" + SystemBase.Base.gstrCOMCD + "'");
                }
                else
                {
                    txtCustNmFr.Value = "";
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_MIV506 @pTYPE = 'S1'";
