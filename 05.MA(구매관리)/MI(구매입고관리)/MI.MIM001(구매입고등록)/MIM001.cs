...
namespace MI.MIM001
{
    public partial class MIM001 : UIForm.FPCOMM2
    {
        ...
        private void btnIspPrint_Click(object sender, System.EventArgs e)
        {
            ...
            string[] RptParmValue = new string[21];   // SP 파라메타 값  // 2017.09.22. hma 수정: 20=>21

            RptParmValue[0] = "R2";     // 2017.10.16. hma 수정: S/P에 입고번호만 넘어가는 루틴 별도 처리하여 R1=>R2로 변경함.
			...
			RptParmValue[18] = " ";
			RptParmValue[19] = " ";
            RptParmValue[20] = " ";     // 2017.09.22. hma 추가: 검사원 매개변수
