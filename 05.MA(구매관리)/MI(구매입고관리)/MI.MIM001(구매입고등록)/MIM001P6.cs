...
namespace MI.MIM001
{
    public partial class MIM001P6 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strBtn = "N";
        string returnVal;
        ...
        #region Form Load 시
        private void MIM001P6_Load(object sender, EventArgs e)
        {
            this.Text = "SCM출고번호팝업";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_MIM001  @pTYPE = 'P6'";
                    strQuery += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                    strQuery += ", @pSCM_MVMT_NO = '" + dtpPoDtFr.Text + "' ";
