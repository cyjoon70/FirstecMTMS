...
namespace MC.MCC502
{
    public partial class MCC502 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load시
        private void MCC502_Load(object sender, System.EventArgs e)
        {
        ...
        private void MCC502_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) txtBeneficiaryCust.Focus();
        }

        private void MCC502_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
