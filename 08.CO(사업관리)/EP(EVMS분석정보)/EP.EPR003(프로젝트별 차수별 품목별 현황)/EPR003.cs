#region 작성정보
/*********************************************************************/
// 단위업무명 : 프로젝트별 차수별 품목별 현황
// 작 성 자 : 권 순 철
// 작 성 일 : 2013-04-12
// 작성내용 : 프로젝트별 차수별 품목별 현황 및 관리
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace EP.EPR003
{
    public partial class EPR003 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strProjectNo = "";
        ...
        #region Form Load시
        private void EPR003_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_EPR003 @pType='S1'  ";
        ...
        private void Search_1(int idx, string Series1, string Series2)
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G" + Convert.ToString(idx + 1) + "'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void Search_5()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G5'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void Search_6()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G6'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void Search_7()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G7'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void Search_8()
        {
            ...
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G8'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void Search_9()
        {
            try
            {
                ...
                string strQuery1 = " usp_EPR003 @pType='G9'  ";
                strQuery1 += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "' ";
                strQuery1 += ", @pPROJECT_NO='" + txtProjectNo.Text.Trim() + "'";
                strQuery1 += ", @pPROJECT_SEQ  ='" + txtProjSeq.Text.Trim() + "'";
                strQuery1 += ", @pITEM_CD ='" + txtItemCd.Text.Trim() + "'";
        ...
        private void btnItem_Click(object sender, System.EventArgs e)
        {
            try
            {
                string strQuery = " usp_C_COMMON 'E002', @pSPEC1 = '" + txtProjectNo.Text + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";										// 쿼리
                string[] strWhere = new string[] { "@pCODE", "@pNAME" };				// 쿼리 인자값(조회조건)
        ...
        #region Activated
        private void EPR003_Activated(object sender, System.EventArgs e)
        {
            txtProjectNo.Focus();
        }
        #endregion
