...
namespace AB.ACB002
{
    public partial class ACB002 : UIForm.Buttons
    {
        public ACB002()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACB002_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                ...
                {
                    string RptName = SystemBase.Base.ProgramWhere + @"\Report\ACB002.rpt";    // 레포트경로+레포트명
