...
namespace DA.DAA003
{
    public partial class DAA003P16 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P16()
        public DAA003P16(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P16_Load
        private void DAA003P16_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P16_Shown
        private void DAA003P16_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
