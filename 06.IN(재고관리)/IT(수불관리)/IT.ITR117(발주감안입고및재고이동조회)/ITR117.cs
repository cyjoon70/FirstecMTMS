...
// 작 성 자  :  한 미 애
// 작 성 일  :  2017.09.11.
// 작성내용  :  발주감안등록된 구매오더의 창고입고건 재고이동 처리
// 수 정 일  :
// 수 정 자  :
// 수정내용  :
// 비    고  :
...
namespace IT.ITR117
{
    public partial class ITR117 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void ITR117_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                {
                    // 2017.09.12. hma 추가(Start): 이동잔량구분
                    string strOpenQtyYN = "";
                    if (rdoOpenQtyY.Checked == true) { strOpenQtyYN = "Y"; }
                    else if (rdoOpenQtyY.Checked == true) { strOpenQtyYN = "N"; }
                    // 2017.09.12. hma 추가(End)

                    string strQuery = " usp_ITR117 'S1'";
                    ...
                    strQuery += ", @pOPEN_QTY_YN ='" + strOpenQtyYN + "'";      // 2017.09.12. hma 추가: 이동잔량구분
        ...
        private void ITR117_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void ITR117_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
        ...
        {
            ITR117P1 frm1 = new ITR117P1(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "발주번호")].Text,
                                                ...
                                                Convert.ToDecimal(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "발주감안총수량")].Value),
                                                Convert.ToDecimal(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "창고입고총수량")].Value),
                                                Convert.ToDecimal(fpSpread1.Sheets[0].Cells[e.Row, SystemBase.Base.GridHeadIndex(GHIdx1, "재고이동총수량")].Value) 
                                        );
            frm1.ShowDialog();
        }
    }
