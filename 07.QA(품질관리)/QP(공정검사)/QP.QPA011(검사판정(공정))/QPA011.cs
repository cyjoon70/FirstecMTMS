...
namespace QP.QPA011
{
    public partial class QPA011 : UIForm.FPCOMM2
    {
        #region 변수선언
        string strInspReqNo = "";
        int SearchRow = 0;
        ...
        public QPA011(string param1, string param2, string param3, string param4)
        {
            strInspReqNo = param1;
            strPlantCd = param2;
            strInspReqDt = param3;
        ...
        #region Form Load 시
        private void QPA011_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            strJumpFileName3 = "QP.QPA003.QPA003"; //호출할 화면명

            lnkJump4.Text = "검사내역등록";  //화면에 보여지는 링크명
            strJumpFileName4 = "QP.QPA002.QPA002"; //호출할 화면명
        ...
        protected override void Link4Exec()
        {
            ...
            SystemBase.Base.RodeFormID = "QPA002";			// 이동할 formid를 적어준다.(메뉴id)
            SystemBase.Base.RodeFormText = "검사내역등록(공정)"; 	// 이동할 폼명을 적어준다(메뉴명)
        }
        ...
        private void Grid2_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QPA011  @pTYPE = 'S1'";
        ...
        private void Grid1_Search(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QPA011  @pTYPE = 'S2'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    string strSql1 = " usp_QPA011 '" + strGbn + "'";
        ...
        private void butInspResult_Click(object sender, System.EventArgs e)
        {
            if (txtInspReqNo.Text != "")
            {
                ...
                try
                {
                    //th = new Thread(new ThreadStart(Show_Waiting));           // 2015.05.12. hma 실행시 오류가 발생하여 Waiting Form이 나오지 않도록 주석 처리함.
                    //th.Start();
                    //Thread.Sleep(200);
                    //Waiting_Form.Activate();
                    this.Cursor = System.Windows.Forms.Cursors.WaitCursor;     // 2015.05.12. hma 추가: 마우스 모양 
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        //Waiting_Form.progressBar_temp.Maximum = dt.Rows.Count;    // 2015.05.12. hma 실행시 오류가 발생하여 Waiting Form이 나오지 않도록 주석 처리함.
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++) //내용입력
                        {
                            ...
                            //Waiting_Form.progressBar_temp.Value = i + 1;      // 2015.05.12. hma 실행시 오류가 발생하여 Waiting Form이 나오지 않도록 주석 처리함.
                        ...
                        //Waiting_Form.label_temp.Text = "완료되었습니다.";        // 2015.05.12. hma 실행시 오류가 발생하여 Waiting Form이 나오지 않도록 주석 처리함.
                        //Thread.Sleep(500);
                ...
                {
                    //Waiting_Form.Close();     // 2015.05.12. hma 실행시 오류가 발생하여 Waiting Form이 나오지 않도록 주석 처리함.
                    //th.Abort();
                    File.SetAttributes(strFileName, System.IO.FileAttributes.Normal);
                }
            }
            this.Cursor = System.Windows.Forms.Cursors.Default;     // 2015.05.12. hma 추가: 마우스 모양
        }
