...
namespace IT.ITR106
{
    public partial class ITR106 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void ITR106_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        private void ITR106_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) cboPlantCd.Focus();
        }

        private void ITR106_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
