...
namespace QT.QTC006
{
    public partial class QTC006P1 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region 생성자
        public QTC006P1(string sInspClassCd, string sPlantCd, string sProjectNo, string sProjectSeq, string sLotNo, string sItemCd, string sUnit, string sInspQty, string sMvmtNo, string sMvmtSeq)
        {
            strInspClassCd = sInspClassCd;
            strPlantCd = sPlantCd;
        ...
        #region 폼로드 이벤트
        private void QTC006P1_Load(object sender, System.EventArgs e)
        {
            ...
            txtInspClassCd.Value = strInspClassCd;
