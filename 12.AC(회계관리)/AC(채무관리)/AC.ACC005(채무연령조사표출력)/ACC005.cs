...
namespace AC.ACC005
{
    public partial class ACC005 : UIForm.Buttons
    {
        public ACC005()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void ACC005_Load(object sender, System.EventArgs e)
        {
            NewExec();
        }
        #endregion
        ...
        protected override void PrintExec()
        {
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    {
                        RptName = SystemBase.Base.ProgramWhere + @"\Report\ACC005_1.rpt";    // 레포트경로+레포트명
                    }
                    else
                    {
                        RptName = SystemBase.Base.ProgramWhere + @"\Report\ACC005_2.rpt";    // 레포트경로+레포트명
                    }
