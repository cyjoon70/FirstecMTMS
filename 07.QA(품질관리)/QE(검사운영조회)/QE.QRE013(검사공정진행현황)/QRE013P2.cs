...
namespace QE.QRE013
{
    public partial class QRE013P2 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        public QRE013P2(string Wo_No, string ProcSeq)
        {
            strWo_No = Wo_No;
            strProcSeq = ProcSeq;
        ...
        #region 폼로드 이벤트
        private void QRE013P2_Load(object sender, System.EventArgs e)
        {
            this.Text = "부품내역";
            ...
            string Query = " usp_QRE013 @pTYPE = 'S4'";
