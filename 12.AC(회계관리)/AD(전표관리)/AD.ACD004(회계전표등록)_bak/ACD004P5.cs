...
namespace AD.ACD004
{
    public partial class ACD004P5 : UIForm.FPCOMM1
    {
        #region 변수선언
        DataTable Dt = null;
        string strCUR_CD = "";
        ...
        public ACD004P5(DataTable Asset_Dt, string CUR_CD, double EXCH_RATE, string ACCT_CD)
        {
            Dt = Asset_Dt;
            strCUR_CD = CUR_CD;
        ...
        #region Form Load 시
        private void ACD004P5_Load(object sender, System.EventArgs e)
        {
            try
            {
                ////////////////////////////그룹박스 초기화 //////////////////////////////////////////////////////////////////////////
