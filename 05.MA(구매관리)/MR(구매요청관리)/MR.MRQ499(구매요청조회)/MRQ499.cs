...
namespace MR.MRQ499
{
    public partial class MRQ499 : UIForm.FPCOMM1
    {
        public MRQ499()
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void MRQ499_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        //구매요청번호 FROM
        private void btnReqNoFr_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                string[] strSearch = new string[] { txtReqNoFr.Text, "" };
                ...
                if (pu.DialogResult == DialogResult.OK)
                {
                    ...
                    txtReqNoFr.Text = Msgs[0].ToString();
        ...
        //구매요청번호 TO
        private void btnReqNoTo_Click(object sender, System.EventArgs e)
        {
            try
            {
                string strQuery = "usp_MRQ499 @pTYPE = 'P1'";
                strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                string[] strWhere = new string[] { "@pCODE", "" };
                string[] strSearch = new string[] { txtReqNoTo.Text, "" };
                ...
                if (pu.DialogResult == DialogResult.OK)
                {
                    ...
                    txtReqNoTo.Text = Msgs[0].ToString();
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    if (rdoCfm0.Checked == true) strCfm = "0";

                    string strQuery = "usp_MRQ499 @pTYPE = 'S1'";
                    strQuery += ", @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "'";
                    strQuery += ", @pREQ_NO_FR = '" + txtReqNoFr.Text + "'";
                    strQuery += ", @pREQ_NO_TO = '" + txtReqNoTo.Text + "'";
