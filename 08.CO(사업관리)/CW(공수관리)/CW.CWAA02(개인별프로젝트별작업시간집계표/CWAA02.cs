#region 작성정보
/*********************************************************************/
// 단위업무명 : 개인별프로젝트별작업시간집계표
// 작 성 자 : 김현근
// 작 성 일 : 2013-04-22
// 작성내용 : 개인별프로젝트별작업시간집계표
// 수 정 일 :
// 수 정 자 :
// 수정내용 :
// 비    고 :
...
namespace CW.CWAA02
{
    public partial class CWAA02 : UIForm.FPCOMM1
    {
        #region 변수선언       
        ...
        #region Form Load 시
        private void CWAA02_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    string strQuery = "usp_CWAA02 @pTYPE = 'S1'";
        ...
        private void Set_Section()
        {
            ...
            for (int i = 7; i < 19; i++)
            {
                string strDtFr =  Convert.ToDateTime(dtpWorkDtFr.Text + "-01").AddMonths(i - 7).ToString();
            ...
            for (int i = 0; i < iCnt; i++)
            {
                ...
                fpSpread1.Sheets[0].SetColumnMerge(5, FarPoint.Win.Spread.Model.MergePolicy.Always);
                fpSpread1.Sheets[0].SetColumnMerge(6, FarPoint.Win.Spread.Model.MergePolicy.Always);
