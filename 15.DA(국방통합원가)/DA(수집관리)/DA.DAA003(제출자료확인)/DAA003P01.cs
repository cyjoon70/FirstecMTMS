#region DAA003P01 작성 정보
/*************************************************************/
// 단위업무명 : 원가자료 등록 BOM 내용을 팝업으로 보여준다
// 작 성 자 :   유재규
// 작 성 일 :   2013-06-19
// 작성내용 :   
// 수 정 일 :
...
namespace DA.DAA003
{
    public partial class DAA003P01 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P01()
        public DAA003P01(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE, 
        ...
        #region DAA003P01_Load
        private void DAA003P01_Load(object sender, EventArgs e)
        {
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > " + SystemBase.Base.CodeName("MINOR_CD", "CD_NM", "B_COMM_CODE", strFormName, "AND MAJOR_CD = 'D023' AND COMP_CODE = '" + SystemBase.Base.gstrCOMCD + "'");
        ...
        private void FpGrid_DataSet()
        {
            try
            {
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "품목/구입선")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D014', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                ...
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "투입단위")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D020', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                //소재구입선
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "소재정보")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D016', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);
                //환산단위
                G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "소재정보_2")] = SystemBase.ComboMake.ComboOnGrid("usp_B_COMMON @pType='COMM', @pCODE = 'D020', @pLANG_CD = '" + SystemBase.Base.gstrLangCd + "', @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "'", 0);

                strSql = " usp_DAA003_BOM  ";
                strSql += "  @pTYPE = 'S1'";
        ...
        #region DAA003P01_Shown
        private void DAA003P01_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
