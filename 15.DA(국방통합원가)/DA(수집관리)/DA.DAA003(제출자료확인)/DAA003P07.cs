...
namespace DA.DAA003
{
    public partial class DAA003P07 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region DAA003P07()
        public DAA003P07(string ORDR_YEAR, string DCSN_NUMB, string CALC_DEGR, string DPRT_CODE,
        ...
        #region DAA003P07_Load
        private void DAA003P07_Load(object sender, EventArgs e)
        {
        ...
        #region DAA003P07_Shown
        private void DAA003P07_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
