...
namespace QF.QFA003
{
    public partial class QFA003 : UIForm.FPCOMM3
    {
        #region 변수선언
        ...
        public QFA003(string param1, string param2, string param3, string param4)
        {
            //
        ...
        #region Form Load시
        private void QFA003_Load(object sender, System.EventArgs e)
        {
            //필수체크
            ...
            strJumpFileName1 = "QF.QFA004.QFA004"; //호출할 화면명
        ...
        private void Grid3_Search()
        {
            ...
            try
            {
                ...
                {
                    string strQuery = " usp_QFA003  @pTYPE = 'S1'";
        ...
        private void Grid2_Search(int iRow)
        {
            ...
            try
            {
                string strQuery = " usp_QFA003  @pTYPE = 'S2'";
        ...
        private void Grid1_Search1()
        {
            ...
            try
            {
                string strQuery = " usp_QFA003  @pTYPE = 'S3'";
                        ...
                        if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", false))
                        {
                            ...
                            for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                            {
                                ...
                                if (strHead.Length > 0)
                                {
                                    ...
                                    if (strGbn != "")
                                    {
                                        string strSql = " usp_QFA003 '" + strGbn + "'";
        ...
        private void fpSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                if (strDecisionCd == "N")
                {
                    ...
                    {
                        UIForm.Buttons.ReButton("111110011011", BtnNew, BtnSearch, BtnRCopy, BtnRowIns, BtnCancel, BtnDel, BtnDelete, BtnInsert, BtnExcel, BtnPrint, BtnHelp, BtnClose);
                    }
                    else
                    {
                        UIForm.Buttons.ReButton("111111011011", BtnNew, BtnSearch, BtnRCopy, BtnRowIns, BtnCancel, BtnDel, BtnDelete, BtnInsert, BtnExcel, BtnPrint, BtnHelp, BtnClose);
                    }
