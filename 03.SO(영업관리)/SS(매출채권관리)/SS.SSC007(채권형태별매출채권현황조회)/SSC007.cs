...
namespace SS.SSC007
{
    public partial class SSC007 : UIForm.FPCOMM1
    {
        #region 변수선언
        ...
        #region Form Load 시
        private void SSC007_Load(object sender, System.EventArgs e)
        {
            //GroupBox1 초기화
            SystemBase.Validation.GroupBox_Setting(groupBox1);

            //기타 세팅
            dtpBnDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).ToShortDateString().Substring(0, 7) + "-01";
        ...
        private void Set_Color()
        {
            ...
            {
                if (fpSpread1.Sheets[0].Cells[i, 1].Text == "zzza") //소계
                {
                ...
                else if (fpSpread1.Sheets[0].Cells[i, 1].Text == "zzzz") //합계
                {
        ...
        private void SSC007_Activated(object sender, System.EventArgs e)
        {
            if (form_act_chk == false) dtpBnDtFr.Focus();
        }

        private void SSC007_Deactivate(object sender, System.EventArgs e)
        {
            form_act_chk = true;
        }
        #endregion
