...
namespace MI.MIM001
{ 
    public partial class MIM001P3 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strBtn = "N";
        string returnVal;
        ...
        #region Form Load 시
        private void MIM001P3_Load(object sender, System.EventArgs e)
        {
            this.Text = "통관번호팝업";
            //GroupBo x1 초기화
            ...
            SystemBase.ComboMake.C1Combo(cboPoType, "usp_M_COMMON @pTYPE = 'M026', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 9);
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                string strQuery = " usp_MIM001  @pTYPE = 'P3'";
        ...
        private void btnOk_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (fpSpread1.Sheets[0].Rows.Count > 0)
                {
                    ...
                    RtnStr(fpSpread1.Sheets[0].Cells[TmpRow, SystemBase.Base.GridHeadIndex(GHIdx1, "통관번호")].Text);
                }
            }
            catch (Exception f)
            {
