...
// 작 성 자  :  한미애
// 작 성 일  :  2017-06-30
// 작성내용  :  구매요청건에 대해 미입고 발주건을 연결한 내역 조회
// 수 정 일  :
// 수 정 자  :
// 수정내용  :
// 비    고  :
...
namespace MR.MRQ510
{
    public partial class MRQ510 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strParam1 = "";
        string strParam2 = "";
        ...
        public MRQ510(string param1, string param2, string param3)
        {
        ...
        #region Form Load 시
        private void MRQ510_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery = "usp_MRQ510 @pTYPE = 'S1'";
                    strQuery += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                    ...
                    strQuery += ", @pREF_DT_FR = '" + dtpReqDtFr.Text + "'";
                    strQuery += ", @pREF_DT_TO = '" + dtpReqDtTo.Text + "'";
