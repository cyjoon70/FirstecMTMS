...
namespace DA.DAA002
{
    public partial class DAA002P15 : UIForm.FPCOMM1
    {
        #region 변수선언
        int iPK_SEQ = 0;
        ...
        #region DAA002P15 
        public DAA002P15(int PK_SEQ, string MNUF_CODE, string ORDR_YEAR, string DPRT_CODE, string DCSN_NUMB, string CALC_DEGR, string FormId)
        {
            InitializeComponent();
        ...
        #region DAA002P15_Load
        private void DAA002P15_Load(object sender, EventArgs e)
        {
           ...
           // G1Etc[SystemBase.Base.GridHeadIndex(GHIdx1, "재료비구분")] = SystemBase.ComboMake.ComboOnGrid("usp_CO_COMM_CODE @pTYPE='COMM', @pCOMP_CODE = 'SYS', @pCODE = 'GA017'", 0);
            ...
            this.Text = SystemBase.Base.GetMenuTree(strFormId) + " > 순매출액경비(외화)";
        }
        #endregion
        ...
        #region DAA002P15_Shown 조회
        private void DAA002P15_Shown(object sender, EventArgs e)
        {
            SearchExec();
        }
        #endregion
