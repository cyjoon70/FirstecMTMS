namespace UIForm
{
    partial class FPCOMM1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Name = "FPCOMM1";
			this.Text = "";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.FPCOMM1_Closing);
			this.Load += new System.EventHandler(this.FPCOMM1_Load);
