...
namespace PB.PSB014
{
    public partial class PSB014 : UIForm.FPCOMM2
    {
        int SearchRow = 0;
        int ShowColumn = 0;
        string strKey = "";
        ...
        #region Form Load 시
        private void PSB014_Load(object sender, System.EventArgs e)
        {
            SystemBase.Validation.GroupBox_Setting(groupBox1);//필수적용
            SystemBase.Validation.GroupBox_Setting(groupBox2);

            SystemBase.ComboMake.C1Combo(cboSCH_ID, "usp_P_COMMON 'P520', @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'", 0);
        ...
        private void Grid2_Search()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                try
                {
                    string strQuery = "usp_PSB014 @pTYPE = 'S1'";
        ...
        private void SubSearch(int iRow)
        {
            try
            {
                ...
                txtRepsn_Ord_NO.Value = fpSpread2.Sheets[0].Cells[iRow, SystemBase.Base.GridHeadIndex(GHIdx2, "대표오더번호")].Text;
                ...
                strQuery = strQuery + ", @pSCH_ID  ='" + Convert.ToString(cboSCH_ID.SelectedValue) + "' ";
                ...
                try
                {
                    ...
                    if (SystemBase.Validation.FPGrid_SaveCheck(fpSpread1, this.Name, "fpSpread1", true))
                    {
                        ...
                        for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                        {
                            ...
                            if (strHead.Length > 0)
                            {
                                string strSql = " usp_PSB014 '" + strGbn + "'";
