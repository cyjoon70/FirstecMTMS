...
namespace QE.QRE009
{
    public partial class QRE009 : UIForm.FPCOMM1
    {
        #region 변수선언
        Thread th;
        ...
        #region Form Load시
        private void QRE009_Load(object sender, System.EventArgs e)
        { 
            //필수체크
        ...
        private void Grd_Set()
        {
            ...
            try
            {
                string strQuery = " usp_QRE009  @pTYPE = 'S2'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    fpSpread1.Sheets[0].ColumnCount = 10 + dt.Rows.Count;
        ...
        private void btnItemCdTo_Click(object sender, System.EventArgs e)
        {
            try
            {
                WNDW005 pu = new WNDW005(cboPlantCd.SelectedValue.ToString(), true, txtItemCdTo.Text);
                pu.MaximizeBox = false;
                pu.ShowDialog();
                if (pu.DialogResult == DialogResult.OK)
                {
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                else if (rdoDivEtc.Checked == true) { strDiv = "기타"; }
                else { strDiv = ""; }

                string strQuery = " usp_QRE009  @pTYPE = 'S1'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        //if (div != dt.Rows[i]["BP_CD"].ToString())
                        //{
                            fpSpread1.Sheets[0].RowCount = row_idx + 1;

                            fpSpread1.Sheets[0].Cells[row_idx, 1].Text = dt.Rows[i]["BP_CD"].ToString();
                            fpSpread1.Sheets[0].Cells[row_idx, 2].Text = dt.Rows[i]["BP_NM"].ToString();
                            ...
                            //fpSpread1.Sheets[0].Cells[row_idx,6].Value = dt.Rows[i]["목표불량율"];
                            ...
                            div = dt.Rows[i]["BP_CD"].ToString();
                            row_idx++;
                        //}

                        if (dt.Rows[i]["DEFECT_TYPE_NM"].ToString() != "")
                        {
                            for (int j = 9; j < fpSpread1.Sheets[0].ColumnCount; j++)
                            {
                    ...
                    fpSpread1.Sheets[0].Columns[8, 9].BackColor = fpSpread1.Sheets[0].Columns[10].BackColor;
                    fpSpread1.Sheets[0].Columns[6, 7].BackColor = fpSpread1.Sheets[0].Columns[8].BackColor;
                    fpSpread1.Sheets[0].Columns[4, 5].BackColor = fpSpread1.Sheets[0].Columns[6].BackColor;
                    fpSpread1.Sheets[0].Columns[2, 3].BackColor = fpSpread1.Sheets[0].Columns[4].BackColor;
                    fpSpread1.Sheets[0].Columns[1].BackColor = fpSpread1.Sheets[0].Columns[2].BackColor;
        ...
        private void btnPrivew_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strQuery = " usp_QRE009  @pTYPE = 'R1'";
                strQuery += ", @pPLANT_CD = '" + cboPlantCd.SelectedValue.ToString() + "'";
                strQuery += ", @pINSP_DT_FR = '" + dtpInspDtFr.Text + "'";
                strQuery += ", @pINSP_DT_TO = '" + dtpInspDtTo.Text + "'";
                strQuery += ", @pITEM_CD_FR = '" + txtItemCdFr.Text + "'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    excel.SetCell(24, 1, "거래처코드");
                    excel.SetCell(24, 3, "거래처명");

                    string strQuery1 = " usp_QRE009  @pTYPE = 'R2'";
                    ...
                    strQuery1 += ", @pITEM_CD_FR = '" + txtItemCdFr.Text + "'";
                    strQuery1 += ", @pITEM_CD_TO = '" + txtItemCdTo.Text + "'";
                    strQuery1 += ", @pBP_CD = '" + txtBpCd.Text + "'";
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            excel.SetCell(25 + i, 1, dt1.Rows[i]["BP_CD"].ToString());
                            excel.SetCell(25 + i, 3, dt1.Rows[i]["BP_NM"].ToString());
                    ...
                    string strQuery2 = " usp_QRE009  @pTYPE = 'R3'";
                    ...
                    strQuery2 += ", @pITEM_CD_FR = '" + txtItemCdFr.Text + "'";
                    strQuery2 += ", @pITEM_CD_TO = '" + txtItemCdTo.Text + "'";
                    strQuery2 += ", @pBP_CD = '" + txtBpCd.Text + "'";
