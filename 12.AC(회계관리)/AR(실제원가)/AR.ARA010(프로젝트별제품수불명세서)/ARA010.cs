...
namespace AR.ARA010
{
    public partial class ARA010 : UIForm.FPCOMM1
    {
        #region 변수선언       
        ...
        #region Form Load 시
        private void ARA010_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                ...
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    string strQuery = " usp_ARA010 ";
                    strQuery += " @pLANG_CD ='" + SystemBase.Base.gstrLangCd + "'";
                    strQuery += ", @pPROJECT_NO ='" + txtProject_No.Text + "'";
                    strQuery += ", @pPROJECT_SEQ ='" + txtProjectSeq.Text + "'";                  
                    strQuery += ", @pINPUT_DT_FR ='" + dtpCloseDt.Text.Trim() + "'";
