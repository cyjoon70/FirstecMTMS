...
namespace QD.QDE011
{
    public partial class QDE011 : UIForm.FPCOMM1
    {
        #region 변수선언
        string strInspReqNo = "";
        Thread th;
        ...
        public QDE011(string InspReqNo)
        {
            InitializeComponent();
        ...
        #region Form Load 시
        private void QDE011_Load(object sender, System.EventArgs e)
        {
            //필수체크
        ...
        protected override void SearchExec()
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1) == true)
            {
                ...
                try
                {
                    string strQuery = " usp_QDE011  @pTYPE = 'S1'";
                    ...
                    strQuery += ", @pDEPT_CD = '" + txtDeptCd.Text + "'";       //귀책부서 조건 추가 2015.08.21
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead == "U")
                        {
                            string strSql = " usp_QDE011 'U1'";
                            strSql += ", @pCO_CD = '" + SystemBase.Base.gstrCOMCD + "' ";
                            strSql += ", @pPLANT_CD = '" + cboPlantCd.SelectedValue.ToString() + "' ";
                            strSql += ", @pINSP_REQ_NO = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "검사의뢰번호")].Text.ToString() + "'";    //2015.08.21 추가
                            strSql += ", @pLOT_SIZE_M = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "LOT크기(수정)")].Text.ToString() + "'";    //2015.08.21 추가
                            strSql += ", @pDEFECT_QTY_M = '" + fpSpread1.Sheets[0].Cells[i, SystemBase.Base.GridHeadIndex(GHIdx1, "불량수(수정)")].Text.ToString() + "'";   //2015.08.21 추가
        ...
        private void butNonDisInsert_Click(object sender, EventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                QDE011P1 myForm = new QDE011P1(fpSpread1, iRow
        ...
        private void butPreview_Click(object sender, EventArgs e)
        {
            if (fpSpread1.Sheets[0].Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    string strQuery = " usp_QDE011  @pTYPE = 'R1'";
